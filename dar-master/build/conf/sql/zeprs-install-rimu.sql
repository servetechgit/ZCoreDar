...
INSERT INTO `appupdate` VALUES (1,'2006-07-28 13:01:01','2006-08-03 07:52:36','S','ALTER TABLE zeprs.routineAnte add column descent_315 int(11);\n',NULL,9),(2,'2006-07-09 22:13:00','2006-08-03 07:52:36','S','ALTER TABLE zeprs.testForm add column abdomen_172 int(11);\n',NULL,2),(3,'2006-06-09 10:55:20','2006-08-03 07:52:36','S','ALTER TABLE zeprs.rpr add column dateRprRequest date;\n',NULL,1),(4,'2006-08-11 13:12:48','2006-08-14 07:29:49','S','ALTER TABLE zeprs.rpr add column partner_treatment int(11);\n',NULL,10),(5,'2006-08-11 13:12:48','2006-08-14 07:29:49','S','ALTER TABLE zeprsdemo.rpr add column partner_treatment int(11);\r\n',NULL,11),(6,'2006-08-14 08:45:09','2006-08-14 23:02:00','S','UPDATE zeprs.arvregimen SET referred_art_clinic = 3070 WHERE referred_art_clinic = 1;',NULL,12),(7,'2006-08-22 15:56:54','2006-08-23 21:42:09','S','UPDATE zeprs.patient p1, zeprs.patient p2\r\nSET p1.site_id = p2.site_id\r\nWHERE p1.parent_id = p2.id\r\nAND p1.site_id IS NULL',NULL,13),(8,'2006-09-08 16:40:12','2006-09-14 07:22:17','S','CREATE TABLE zeprs.hemotology (\n  id bigint(20) NOT NULL default \'0\',\n  PRIMARY KEY  (`id`),\n  KEY FKhemotology (id),\n  CONSTRAINT FKhemotology FOREIGN KEY (id) REFERENCES zeprs.encounter (id)\n) ENGINE=InnoDB DEFAULT CHARSET=latin1;',NULL,19),(9,'2006-09-08 16:40:12','2006-09-14 07:22:17','S','CREATE TABLE zeprsdemo.hemotology ( id bigint(20) NOT NULL default \'0\', PRIMARY KEY (`id`), KEY FKhemotology (id), CONSTRAINT FKhemotology FOREIGN KEY (id) REFERENCES zeprsdemo.encounter (id) ) ENGINE=InnoDB DEFAULT CHARSET=latin1;',NULL,102),(10,'2006-09-08 18:29:36','2006-09-14 07:22:17','S','ALTER TABLE zeprs.hemotology add column wbc float;\n',NULL,26),(11,'2006-09-08 18:29:36','2006-09-14 07:22:18','S','ALTER TABLE zeprsdemo.hemotology add column wbc float;\n',NULL,27),(12,'2006-09-08 18:31:18','2006-09-14 07:22:18','S','ALTER TABLE zeprs.hemotology add column rbc float;\n',NULL,28),(13,'2006-09-08 18:31:18','2006-09-14 07:22:18','S','ALTER TABLE zeprsdemo.hemotology add column rbc float;\n',NULL,29),(14,'2006-09-08 18:31:53','2006-09-14 07:22:18','S','ALTER TABLE zeprs.hemotology add column hgb float;\n',NULL,30),(15,'2006-09-08 18:31:53','2006-09-14 07:22:18','S','ALTER TABLE zeprsdemo.hemotology add column hgb float;\n',NULL,31),(16,'2006-09-08 18:32:38','2006-09-14 07:22:18','S','ALTER TABLE zeprs.hemotology add column hct float;\n',NULL,32),(17,'2006-09-08 18:32:38','2006-09-14 07:22:18','S','ALTER TABLE zeprsdemo.hemotology add column hct float;\n',NULL,33),(18,'2006-09-08 18:33:15','2006-09-14 07:22:18','S','ALTER TABLE zeprs.hemotology add column mcv float;\n',NULL,34),(19,'2006-09-08 18:33:15','2006-09-14 07:22:18','S','ALTER TABLE zeprsdemo.hemotology add column mcv float;\n',NULL,35),(20,'2006-09-08 18:33:55','2006-09-14 07:22:18','S','ALTER TABLE zeprs.hemotology add column mch float;\n',NULL,36),(21,'2006-09-08 18:33:55','2006-09-14 07:22:18','S','ALTER TABLE zeprsdemo.hemotology add column mch float;\n',NULL,37),(22,'2006-09-08 18:34:39','2006-09-14 07:22:18','S','ALTER TABLE zeprs.hemotology add column mchc float;\n',NULL,38),(23,'2006-09-08 18:34:39','2006-09-14 07:22:18','S','ALTER TABLE zeprsdemo.hemotology add column mchc float;\n',NULL,39),(24,'2006-09-08 18:35:07','2006-09-14 07:22:18','S','ALTER TABLE zeprs.hemotology add column plt float;\n',NULL,40),(25,'2006-09-08 18:35:07','2006-09-14 07:22:18','S','ALTER TABLE zeprsdemo.hemotology add column plt float;\n',NULL,41),(26,'2006-09-11 10:30:13','2006-09-14 07:22:18','S','CREATE TABLE zeprs.chemistry (\n  id bigint(20) NOT NULL default \'0\',\n  PRIMARY KEY  (`id`),\n  KEY FKchemistry (id),\n  CONSTRAINT FKchemistry FOREIGN KEY (id) REFERENCES zeprs.encounter (id)\n) ENGINE=InnoDB DEFAULT CHARSET=latin1;',NULL,42),(27,'2006-09-11 10:30:13','2006-09-14 07:22:18','S','CREATE TABLE zeprsdemo.chemistry (\n  id bigint(20) NOT NULL default \'0\',\n  PRIMARY KEY  (`id`),\n  KEY FKchemistry (id),\n  CONSTRAINT FKchemistry FOREIGN KEY (id) REFERENCES zeprs.encounter (id)\n) ENGINE=InnoDB DEFAULT CHARSET=latin1;',NULL,43),(28,'2006-09-11 10:37:12','2006-09-14 07:22:18','S','ALTER TABLE zeprs.chemistry add column na float;\n',NULL,44),(29,'2006-09-11 10:37:12','2006-09-14 07:22:18','S','ALTER TABLE zeprsdemo.chemistry add column na float;\n',NULL,45),(30,'2006-09-11 10:39:58','2006-09-14 07:22:18','S','ALTER TABLE zeprs.chemistry add column potassium VARCHAR(255);\n',NULL,46),(31,'2006-09-11 10:39:58','2006-09-14 07:22:18','S','ALTER TABLE zeprsdemo.chemistry add column potassium VARCHAR(255);\n',NULL,47),(32,'2006-09-11 10:56:31','2006-09-14 07:22:18','S','ALTER TABLE zeprs.chemistry add column chlorine int(11);\n',NULL,48),(33,'2006-09-11 10:56:31','2006-09-14 07:22:18','S','ALTER TABLE zeprsdemo.chemistry add column chlorine int(11);\n',NULL,49),(34,'2006-09-11 10:57:10','2006-09-14 07:22:18','S','ALTER TABLE zeprs.chemistry add column bicarb float;\n',NULL,50),(35,'2006-09-11 10:57:10','2006-09-14 07:22:18','S','ALTER TABLE zeprsdemo.chemistry add column bicarb float;\n',NULL,51),(36,'2006-09-11 10:58:16','2006-09-14 07:22:18','S','ALTER TABLE zeprs.chemistry add column gluc int(11);\n',NULL,52),(37,'2006-09-11 10:58:16','2006-09-14 07:22:18','S','ALTER TABLE zeprsdemo.chemistry add column gluc int(11);\n',NULL,53),(38,'2006-09-11 10:59:07','2006-09-14 07:22:18','S','ALTER TABLE zeprs.chemistry add column creat int(11);\n',NULL,54),(39,'2006-09-11 10:59:07','2006-09-14 07:22:18','S','ALTER TABLE zeprsdemo.chemistry add column creat int(11);\n',NULL,55),(40,'2006-09-11 10:59:44','2006-09-14 07:22:18','S','ALTER TABLE zeprs.chemistry add column bun float;\n',NULL,56),(41,'2006-09-11 10:59:44','2006-09-14 07:22:19','S','ALTER TABLE zeprsdemo.chemistry add column bun float;\n',NULL,57),(42,'2006-09-11 12:02:42','2006-09-14 07:22:19','S','CREATE TABLE zeprs.liverfunction (\n  id bigint(20) NOT NULL default \'0\',\n  PRIMARY KEY  (`id`),\n  KEY FKliverfunction (id),\n  CONSTRAINT FKliverfunction FOREIGN KEY (id) REFERENCES zeprs.encounter (id)\n) ENGINE=InnoDB DEFAULT CHARSET=latin1;',NULL,58),(43,'2006-09-11 12:02:42','2006-09-14 07:22:19','S','CREATE TABLE zeprsdemo.liverfunction (\n  id bigint(20) NOT NULL default \'0\',\n  PRIMARY KEY  (`id`),\n  KEY FKliverfunction (id),\n  CONSTRAINT FKliverfunction FOREIGN KEY (id) REFERENCES zeprs.encounter (id)\n) ENGINE=InnoDB DEFAULT CHARSET=latin1;',NULL,59),(44,'2006-09-11 12:03:31','2006-09-14 07:22:19','S','ALTER TABLE zeprs.liverfunction add column alt int(11);\n',NULL,60),(45,'2006-09-11 12:03:31','2006-09-14 07:22:19','S','ALTER TABLE zeprsdemo.liverfunction add column alt int(11);\n',NULL,61),(46,'2006-09-11 12:04:10','2006-09-14 07:22:19','S','ALTER TABLE zeprs.liverfunction add column ast int(11);\n',NULL,62),(47,'2006-09-11 12:04:10','2006-09-14 07:22:19','S','ALTER TABLE zeprsdemo.liverfunction add column ast int(11);\n',NULL,63),(48,'2006-09-11 12:04:46','2006-09-14 07:22:19','S','ALTER TABLE zeprs.liverfunction add column alk_phos int(11);\n',NULL,64),(49,'2006-09-11 12:04:46','2006-09-14 07:22:19','S','ALTER TABLE zeprsdemo.liverfunction add column alk_phos int(11);\n',NULL,65),(50,'2006-09-11 12:05:26','2006-09-14 07:22:19','S','ALTER TABLE zeprs.liverfunction add column tbili float;\n',NULL,66),(51,'2006-09-11 12:05:26','2006-09-14 07:22:19','S','ALTER TABLE zeprsdemo.liverfunction add column tbili float;\n',NULL,67),(52,'2006-09-11 12:05:57','2006-09-14 07:22:19','S','ALTER TABLE zeprs.liverfunction add column dbili float;\n',NULL,68),(53,'2006-09-11 12:05:57','2006-09-14 07:22:19','S','ALTER TABLE zeprsdemo.liverfunction add column dbili float;\n',NULL,69),(54,'2006-09-11 12:06:22','2006-09-14 07:22:19','S','ALTER TABLE zeprs.liverfunction add column ggt int(11);\n',NULL,70),(55,'2006-09-11 12:06:22','2006-09-14 07:22:19','S','ALTER TABLE zeprsdemo.liverfunction add column ggt int(11);\n',NULL,71),(56,'2006-09-11 13:07:46','2006-09-14 07:22:19','S','CREATE TABLE zeprs.urinalysis (\n  id bigint(20) NOT NULL default \'0\',\n  PRIMARY KEY  (`id`),\n  KEY FKurinalysis (id),\n  CONSTRAINT FKurinalysis FOREIGN KEY (id) REFERENCES zeprs.encounter (id)\n) ENGINE=InnoDB DEFAULT CHARSET=latin1;',NULL,72),(57,'2006-09-11 13:07:46','2006-09-14 07:22:19','S','CREATE TABLE zeprsdemo.urinalysis (\n  id bigint(20) NOT NULL default \'0\',\n  PRIMARY KEY  (`id`),\n  KEY FKurinalysis (id),\n  CONSTRAINT FKurinalysis FOREIGN KEY (id) REFERENCES zeprs.encounter (id)\n) ENGINE=InnoDB DEFAULT CHARSET=latin1;',NULL,73),(58,'2006-09-11 15:06:18','2006-09-14 07:22:19','S','ALTER TABLE zeprs.hemotology add column labtest_id bigint(20);\n',NULL,74),(59,'2006-09-11 15:06:18','2006-09-14 07:22:19','S','ALTER TABLE zeprsdemo.hemotology add column labtest_id bigint(20);\n',NULL,75),(60,'2006-09-12 07:35:09','2006-09-14 07:22:19','S','ALTER TABLE zeprs.urinalysis add column leuk_est int(11);\n',NULL,76),(61,'2006-09-12 07:35:09','2006-09-14 07:22:19','S','ALTER TABLE zeprsdemo.urinalysis add column leuk_est int(11);\n',NULL,77),(62,'2006-09-12 07:40:19','2006-09-14 07:22:19','S','ALTER TABLE zeprs.urinalysis add column nitrite int(11);\n',NULL,78),(63,'2006-09-12 07:40:19','2006-09-14 07:22:19','S','ALTER TABLE zeprsdemo.urinalysis add column nitrite int(11);\n',NULL,79),(64,'2006-09-12 07:47:25','2006-09-14 07:22:20','S','ALTER TABLE zeprs.urinalysis add column urinalysis_ace_244 int(11);\n',NULL,80),(65,'2006-09-12 07:47:25','2006-09-14 07:22:20','S','ALTER TABLE zeprsdemo.urinalysis add column urinalysis_ace_244 int(11);\n',NULL,81),(66,'2006-09-12 07:48:16','2006-09-14 07:22:20','S','ALTER TABLE zeprs.urinalysis add column urinalysis_alb_242 int(11);\n',NULL,82),(67,'2006-09-12 07:48:16','2006-09-14 07:22:20','S','ALTER TABLE zeprsdemo.urinalysis add column urinalysis_alb_242 int(11);\n',NULL,83),(68,'2006-09-12 07:48:29','2006-09-14 07:22:20','S','ALTER TABLE zeprs.urinalysis add column urinalysis_glu_243 int(11);\n',NULL,84),(69,'2006-09-12 07:48:29','2006-09-14 07:22:20','S','ALTER TABLE zeprsdemo.urinalysis add column urinalysis_glu_243 int(11);\n',NULL,85),(70,'2006-09-12 07:51:54','2006-09-14 07:22:20','S','ALTER TABLE zeprs.urinalysis add column wbc_urinalysis int(11);\n',NULL,86),(71,'2006-09-12 07:51:54','2006-09-14 07:22:20','S','ALTER TABLE zeprsdemo.urinalysis add column wbc_urinalysis int(11);\n',NULL,87),(72,'2006-09-12 07:53:03','2006-09-14 07:22:20','S','ALTER TABLE zeprs.urinalysis add column bacteria int(11);\n',NULL,88),(73,'2006-09-12 07:53:03','2006-09-14 07:22:20','S','ALTER TABLE zeprsdemo.urinalysis add column bacteria int(11);\n',NULL,89),(74,'2006-09-12 09:50:04','2006-09-14 07:22:21','S','ALTER TABLE zeprs.labtest add column extended_test_id bigint(20);\n',NULL,90),(75,'2006-09-12 09:50:04','2006-09-14 07:22:21','S','ALTER TABLE zeprsdemo.labtest add column extended_test_id bigint(20);\n',NULL,91),(76,'2006-09-12 10:52:02','2006-09-14 07:22:21','S','ALTER TABLE zeprs.chemistry add column labtest_id bigint(20);\n',NULL,92),(77,'2006-09-12 10:52:02','2006-09-14 07:22:21','S','ALTER TABLE zeprsdemo.chemistry add column labtest_id bigint(20);\n',NULL,93),(78,'2006-09-12 10:54:10','2006-09-14 07:22:21','S','ALTER TABLE zeprs.liverfunction add column labtest_id bigint(20);\n',NULL,94),(79,'2006-09-12 10:54:10','2006-09-14 07:22:21','S','ALTER TABLE zeprsdemo.liverfunction add column labtest_id bigint(20);\n',NULL,95),(80,'2006-09-12 10:54:35','2006-09-14 07:22:21','S','ALTER TABLE zeprs.urinalysis add column labtest_id bigint(20);\n',NULL,96),(81,'2006-09-12 10:54:35','2006-09-14 07:22:21','S','ALTER TABLE zeprsdemo.urinalysis add column labtest_id bigint(20);\n',NULL,97),(82,'2006-09-13 14:44:33','2006-09-14 07:22:21','S','ALTER TABLE zeprs.deliverysum add column utherine_massage tinyint(4);\n',NULL,98),(83,'2006-09-13 14:44:33','2006-09-14 07:22:22','S','ALTER TABLE zeprsdemo.deliverysum add column utherine_massage tinyint(4);\n',NULL,99),(84,'2006-09-13 14:46:56','2006-09-14 07:22:22','S','ALTER TABLE zeprs.deliverysum add column uterotonic_med_given int(11);\n',NULL,100),(85,'2006-09-13 14:46:56','2006-09-14 07:22:22','S','ALTER TABLE zeprsdemo.deliverysum add column uterotonic_med_given int(11);\n',NULL,101),(86,'2007-05-01 11:19:35','2007-05-04 06:23:14','S','ALTER TABLE zeprs.newborneval add column general_examination int(11);\n',NULL,103),(87,'2007-05-01 11:19:35','2007-05-04 06:23:14','S','ALTER TABLE zeprsdemo.newborneval add column general_examination int(11);\n',NULL,104),(88,'2007-05-01 11:23:42','2007-05-04 06:23:14','S','ALTER TABLE zeprs.postnatalinfant add column infant_hiv_test int(11);\n',NULL,105),(89,'2007-05-01 11:23:42','2007-05-04 06:23:15','S','ALTER TABLE zeprsdemo.postnatalinfant add column infant_hiv_test int(11);\n',NULL,106),(90,'2007-05-01 11:28:16','2007-05-04 06:23:15','S','ALTER TABLE zeprs.postnatalinfant add column hiv_test_result int(11);\n',NULL,107),(91,'2007-05-01 11:28:16','2007-05-04 06:23:15','S','ALTER TABLE zeprsdemo.postnatalinfant add column hiv_test_result int(11);\n',NULL,108),(92,'2007-05-01 11:31:45','2007-05-04 06:23:15','S','ALTER TABLE zeprs.postnatalinfant add column hiv_test_date date;\n',NULL,109),(93,'2007-05-01 11:31:45','2007-05-04 06:23:15','S','ALTER TABLE zeprsdemo.postnatalinfant add column hiv_test_date date;\n',NULL,110),(94,'2007-05-01 11:32:47','2007-05-04 06:23:15','S','ALTER TABLE zeprs.postnatalinfant add column septrin_prescribed_today tinyint(4);\n',NULL,111),(95,'2007-05-01 11:32:47','2007-05-04 06:23:15','S','ALTER TABLE zeprsdemo.postnatalinfant add column septrin_prescribed_today tinyint(4);\n',NULL,112),(96,'2007-05-01 11:36:22','2007-05-04 06:23:18','S','ALTER TABLE zeprs.patientregistration add column uth_referral_type int(11);\n',NULL,113),(97,'2007-05-01 11:36:22','2007-05-04 06:23:18','S','ALTER TABLE zeprsdemo.patientregistration add column uth_referral_type int(11);\n',NULL,114),(98,'2007-05-03 11:36:25','2007-05-04 06:23:18','S','ALTER TABLE zeprs.newborneval add column ega_weeks int(11);\n',NULL,115),(99,'2007-05-03 11:36:25','2007-05-04 06:23:18','S','ALTER TABLE zeprsdemo.newborneval add column ega_weeks int(11);\n',NULL,116),(100,'2007-06-11 14:49:01','2007-06-19 11:13:34','S','CREATE TABLE zeprs.testck (\n  id bigint(20) NOT NULL default \'0\',\n  PRIMARY KEY  (`id`),\n  KEY FKtestck (id),\n  CONSTRAINT FKtestck FOREIGN KEY (id) REFERENCES zeprs.encounter (id)\n) ENGINE=InnoDB DEFAULT CHARSET=latin1;',NULL,117),(101,'2007-06-11 14:49:24','2007-06-19 11:13:34','S','ALTER TABLE zeprs.testck add column title VARCHAR(255);\n',NULL,118),(102,'2007-06-11 14:49:24','2007-06-19 11:13:34','S','ALTER TABLE zeprsdemo.testck add column title VARCHAR(255);\n',NULL,119),(103,'2007-06-11 14:49:46','2007-06-19 11:13:34','S','ALTER TABLE zeprs.testck add column firstname VARCHAR(255);\n',NULL,120),(104,'2007-06-11 14:49:46','2007-06-19 11:13:34','S','ALTER TABLE zeprsdemo.testck add column firstname VARCHAR(255);\n',NULL,121),(105,'2007-06-11 14:50:11','2007-06-19 11:13:34','S','ALTER TABLE zeprs.testck add column states int(11);\n',NULL,122),(106,'2007-06-11 14:50:11','2007-06-19 11:13:34','S','ALTER TABLE zeprsdemo.testck add column states int(11);\n',NULL,123),(107,'2007-06-11 14:51:11','2007-06-19 11:13:34','S','ALTER TABLE zeprs.testck add column dateVisit date;\n',NULL,124),(108,'2007-06-11 14:51:11','2007-06-19 11:13:34','S','ALTER TABLE zeprsdemo.testck add column dateVisit date;\n',NULL,125),(109,'2007-06-11 17:05:14','2007-06-19 11:13:34','S','CREATE TABLE zeprs.testck2 (\n  id bigint(20) NOT NULL default \'0\',\n  PRIMARY KEY  (`id`),\n  KEY FKtestck2 (id),\n  CONSTRAINT FKtestck2 FOREIGN KEY (id) REFERENCES zeprs.encounter (id)\n) ENGINE=InnoDB DEFAULT CHARSET=latin1;',NULL,126),(110,'2007-06-11 20:24:03','2007-06-19 11:13:35','S','CREATE TABLE zeprs.testCK3 (\n  id bigint(20) NOT NULL default \'0\',\n  PRIMARY KEY  (`id`),\n  KEY FKtestCK3 (id),\n  CONSTRAINT FKtestCK3 FOREIGN KEY (id) REFERENCES zeprs.encounter (id)\n) ENGINE=InnoDB DEFAULT CHARSET=latin1;',NULL,127),(111,'2007-06-11 20:28:58','2007-06-19 11:13:35','S','CREATE TABLE zeprs.testCK4 (\n  id bigint(20) NOT NULL default \'0\',\n  PRIMARY KEY  (`id`),\n  KEY FKtestCK4 (id),\n  CONSTRAINT FKtestCK4 FOREIGN KEY (id) REFERENCES zeprs.encounter (id)\n) ENGINE=InnoDB DEFAULT CHARSET=latin1;',NULL,128),(112,'2007-06-11 20:28:58','2007-06-19 11:13:35','S','CREATE TABLE zeprsdemo.testCK4 (\n  id bigint(20) NOT NULL default \'0\',\n  PRIMARY KEY  (`id`),\n  KEY FKtestCK4 (id),\n  CONSTRAINT FKtestCK4 FOREIGN KEY (id) REFERENCES zeprs.encounter (id)\n) ENGINE=InnoDB DEFAULT CHARSET=latin1;',NULL,129),(113,'2007-06-11 20:29:49','2007-06-19 11:13:35','S','ALTER TABLE zeprs.testck4 add column first_feild VARCHAR(255);\n',NULL,130),(114,'2007-06-11 20:29:49','2007-06-19 11:13:35','S','ALTER TABLE zeprsdemo.testck4 add column first_feild VARCHAR(255);\n',NULL,131),(115,'2007-06-19 14:59:25','2007-06-19 16:24:12','S','ALTER TABLE zeprs.medsurghist add column family_history_birth_defects tinyint(4);\n',NULL,132),(116,'2007-06-19 14:59:25','2007-06-19 16:24:12','S','ALTER TABLE zeprsdemo.medsurghist add column family_history_birth_defects tinyint(4);\n',NULL,133),(117,'2007-06-19 15:13:02','2007-06-19 16:24:13','S','ALTER TABLE zeprs.deliverysum add column regimen int(11);\n',NULL,134),(118,'2007-06-19 15:13:02','2007-06-19 16:24:13','S','ALTER TABLE zeprsdemo.deliverysum add column regimen int(11);\n',NULL,135),(119,'2007-06-25 10:00:08','2007-06-25 10:38:27','S','ALTER TABLE zeprs.newborneval add column skin_176 int(11);\n',NULL,136),(120,'2007-06-25 10:00:08','2007-06-25 10:38:27','S','ALTER TABLE zeprsdemo.newborneval add column skin_176 int(11);\n',NULL,137),(121,'2007-06-25 10:34:27','2007-06-25 10:38:27','S','ALTER TABLE zeprs.newborneval add column skin_700 int(11);\n',NULL,138),(122,'2007-06-25 10:34:27','2007-06-25 10:38:27','S','ALTER TABLE zeprsdemo.newborneval add column skin_700 int(11);\n',NULL,139),(123,'2007-06-25 11:45:19','2007-06-25 14:31:04','S','ALTER TABLE zeprs.newborneval add column head_ears_nose_throat int(11);\n',NULL,140),(124,'2007-06-25 11:45:19','2007-06-25 14:31:04','S','ALTER TABLE zeprsdemo.newborneval add column head_ears_nose_throat int(11);\n',NULL,141),(125,'2007-06-25 11:48:15','2007-06-25 14:31:04','S','ALTER TABLE zeprs.newborneval add column hent_abnormality VARCHAR(255);\n',NULL,142),(126,'2007-06-25 11:48:15','2007-06-25 14:31:04','S','ALTER TABLE zeprsdemo.newborneval add column hent_abnormality VARCHAR(255);\n',NULL,143),(127,'2007-06-25 12:23:50','2007-06-25 14:31:04','S','ALTER TABLE zeprs.newborneval add column respiratory_system_167 int(11);\n',NULL,144),(128,'2007-06-25 12:23:50','2007-06-25 14:31:04','S','ALTER TABLE zeprsdemo.newborneval add column respiratory_system_167 int(11);\n',NULL,145),(129,'2007-06-25 12:24:05','2007-06-25 14:31:04','S','ALTER TABLE zeprs.newborneval add column respiratory_system_other VARCHAR(255);\n',NULL,146),(130,'2007-06-25 12:24:05','2007-06-25 14:31:04','S','ALTER TABLE zeprsdemo.newborneval add column respiratory_system_other VARCHAR(255);\n',NULL,147),(131,'2007-06-25 12:26:10','2007-06-25 14:31:04','S','ALTER TABLE zeprs.newborneval add column cardovascular_examination int(11);\n',NULL,148),(132,'2007-06-25 12:26:10','2007-06-25 14:31:04','S','ALTER TABLE zeprsdemo.newborneval add column cardovascular_examination int(11);\n',NULL,149),(133,'2007-06-25 12:27:01','2007-06-25 14:31:04','S','ALTER TABLE zeprs.newborneval add column cardiovascular_abnormality VARCHAR(255);\n',NULL,150),(134,'2007-06-25 12:27:01','2007-06-25 14:31:04','S','ALTER TABLE zeprsdemo.newborneval add column cardiovascular_abnormality VARCHAR(255);\n',NULL,151),(135,'2007-06-25 12:36:46','2007-06-25 14:31:04','S','ALTER TABLE zeprs.newborneval add column abdominal_exam int(11);\n',NULL,152),(136,'2007-06-25 12:36:46','2007-06-25 14:31:04','S','ALTER TABLE zeprsdemo.newborneval add column abdominal_exam int(11);\n',NULL,153),(137,'2007-06-25 12:47:32','2007-06-25 14:31:04','S','ALTER TABLE zeprs.newborneval add column congenital_malformations tinyint(4);\n',NULL,154),(138,'2007-06-25 12:47:32','2007-06-25 14:31:04','S','ALTER TABLE zeprsdemo.newborneval add column congenital_malformations tinyint(4);\n',NULL,155),(139,'2007-06-25 12:49:30','2007-06-25 14:31:04','S','ALTER TABLE zeprs.newborneval add column congenital_malformations_system int(11);\n',NULL,156),(140,'2007-06-25 12:49:30','2007-06-25 14:31:04','S','ALTER TABLE zeprsdemo.newborneval add column congenital_malformations_system int(11);\n',NULL,157),(141,'2007-06-25 12:55:27','2007-06-25 14:31:04','S','ALTER TABLE zeprs.newborneval add column abnormality_crano_facial int(11);\n',NULL,158),(142,'2007-06-25 12:55:27','2007-06-25 14:31:04','S','ALTER TABLE zeprsdemo.newborneval add column abnormality_crano_facial int(11);\n',NULL,159),(143,'2007-06-25 15:24:44','2007-06-25 16:58:13','S','ALTER TABLE zeprs.newborneval add column skin_other_701 VARCHAR(255);\n',NULL,160),(144,'2007-06-25 15:24:44','2007-06-25 16:58:13','S','ALTER TABLE zeprsdemo.newborneval add column skin_other_701 VARCHAR(255);\n',NULL,161),(145,'2007-06-25 17:00:02','2007-06-25 17:23:17','S','update zeprs.newborneval set good_grasp_reflex_521 = 1 where good_grasp_reflex_521 = 295\r',NULL,162),(146,'2007-06-25 17:00:03','2007-06-25 17:23:17','S','update zeprs.newborneval set good_grasp_reflex_521 = 0 where good_grasp_reflex_521 = 827',NULL,163),(147,'2007-06-26 11:06:17','2007-06-26 13:06:21','S','ALTER TABLE zeprs.newborneval add column abdominal_abnormality VARCHAR(255);\n',NULL,164),(148,'2007-06-26 11:06:17','2007-06-26 13:06:21','S','ALTER TABLE zeprsdemo.newborneval add column abdominal_abnormality VARCHAR(255);\n',NULL,165),(149,'2007-06-26 15:12:49','2007-06-26 17:02:01','S','ALTER TABLE zeprs.newborneval add column congen_malform_system1 int(11);\n',NULL,166),(150,'2007-06-26 15:12:49','2007-06-26 17:02:01','S','ALTER TABLE zeprsdemo.newborneval add column congen_malform_system1 int(11);\n',NULL,167),(151,'2007-06-26 15:27:22','2007-06-26 17:02:01','S','ALTER TABLE zeprs.newborneval add column congen_malform_system2 int(11);\n',NULL,168),(152,'2007-06-26 15:27:22','2007-06-26 17:02:01','S','ALTER TABLE zeprsdemo.newborneval add column congen_malform_system2 int(11);\n',NULL,169),(153,'2007-06-26 15:28:17','2007-06-26 17:02:01','S','ALTER TABLE zeprs.newborneval add column congen_malform_system3 int(11);\n',NULL,170),(154,'2007-06-26 15:28:17','2007-06-26 17:02:01','S','ALTER TABLE zeprsdemo.newborneval add column congen_malform_system3 int(11);\n',NULL,171),(155,'2007-06-26 16:33:51','2007-06-26 17:02:01','S','ALTER TABLE zeprs.newborneval add column congen_malform_system4 int(11);\n',NULL,172),(156,'2007-06-26 16:33:51','2007-06-26 17:02:01','S','ALTER TABLE zeprsdemo.newborneval add column congen_malform_system4 int(11);\n',NULL,173),(157,'2007-06-26 16:34:26','2007-06-26 17:02:01','S','ALTER TABLE zeprs.newborneval add column congen_malform_system5 int(11);\n',NULL,174),(158,'2007-06-26 16:34:26','2007-06-26 17:02:02','S','ALTER TABLE zeprsdemo.newborneval add column congen_malform_system5 int(11);\n',NULL,175),(159,'2007-06-26 16:34:56','2007-06-26 17:02:02','S','ALTER TABLE zeprs.newborneval add column congen_malform_system6 int(11);\n',NULL,176),(160,'2007-06-26 16:34:56','2007-06-26 17:02:02','S','ALTER TABLE zeprsdemo.newborneval add column congen_malform_system6 int(11);\n',NULL,177),(161,'2007-06-26 16:35:31','2007-06-26 17:02:02','S','ALTER TABLE zeprs.newborneval add column congen_malform_system7 int(11);\n',NULL,178),(162,'2007-06-26 16:35:31','2007-06-26 17:02:02','S','ALTER TABLE zeprsdemo.newborneval add column congen_malform_system7 int(11);\n',NULL,179),(163,'2007-06-26 16:35:58','2007-06-26 17:02:02','S','ALTER TABLE zeprs.newborneval add column congen_malform_system8 int(11);\n',NULL,180),(164,'2007-06-26 16:35:58','2007-06-26 17:02:02','S','ALTER TABLE zeprsdemo.newborneval add column congen_malform_system8 int(11);\n',NULL,181),(165,'2007-06-27 11:03:31','2007-06-27 11:48:15','S','CREATE TABLE zeprs.newbornrecord (\n  id bigint(20) NOT NULL default \'0\',\n  PRIMARY KEY  (`id`),\n  KEY FKnewbornrecord (id),\n  CONSTRAINT FKnewbornrecord FOREIGN KEY (id) REFERENCES zeprs.encounter (id)\n) ENGINE=InnoDB DEFAULT CHARSET=latin1;',NULL,183),(166,'2007-06-27 11:03:31','2007-06-27 11:48:15','S','CREATE TABLE zeprsdemo.newbornrecord (\n  id bigint(20) NOT NULL default \'0\',\n  PRIMARY KEY  (`id`),\n  KEY FKnewbornrecord (id),\n  CONSTRAINT FKnewbornrecord FOREIGN KEY (id) REFERENCES zeprs.encounter (id)\n) ENGINE=InnoDB DEFAULT CHARSET=latin1;',NULL,184),(167,'2007-06-27 11:04:16','2007-06-27 11:48:15','S','ALTER TABLE zeprs.newbornrecord add column date_of_birth date;\n',NULL,185),(168,'2007-06-27 11:04:16','2007-06-27 11:48:16','S','ALTER TABLE zeprsdemo.newbornrecord add column date_of_birth date;\n',NULL,186),(169,'2007-06-27 11:06:18','2007-06-27 11:48:16','S','ALTER TABLE zeprs.newbornrecord add column time_of_birth_1514 time;\n',NULL,187),(170,'2007-06-27 11:06:18','2007-06-27 11:48:16','S','ALTER TABLE zeprsdemo.newbornrecord add column time_of_birth_1514 time;\n',NULL,188),(171,'2007-06-27 11:52:43','2007-06-27 11:55:40','S','ALTER TABLE zeprs.newbornrecord add column sequence_num_489 int(11);\n',NULL,189),(172,'2007-06-27 11:52:43','2007-06-27 11:55:40','S','ALTER TABLE zeprsdemo.newbornrecord add column sequence_num_489 int(11);\n',NULL,190),(173,'2007-06-27 12:05:36','2007-06-27 12:27:27','S','ALTER TABLE zeprs.newbornrecord add column sex_490 tinyint(4);\n',NULL,191),(174,'2007-06-27 12:05:36','2007-06-27 12:27:27','S','ALTER TABLE zeprsdemo.newbornrecord add column sex_490 tinyint(4);\n',NULL,192),(175,'2007-06-27 12:39:13','2007-06-27 14:19:18','S','ALTER TABLE zeprs.newbornrecord add column weight_at_birth_491 float;\n',NULL,193),(176,'2007-06-27 12:39:13','2007-06-27 14:19:18','S','ALTER TABLE zeprsdemo.newbornrecord add column weight_at_birth_491 float;\n',NULL,194),(177,'2007-06-27 12:45:30','2007-06-27 14:19:18','S','ALTER TABLE zeprs.newbornrecord add column ega_weeks int(11);\n',NULL,195),(178,'2007-06-27 12:45:30','2007-06-27 14:19:18','S','ALTER TABLE zeprsdemo.newbornrecord add column ega_weeks int(11);\n',NULL,196),(179,'2007-06-28 13:17:45','2007-06-28 13:29:39','S','ALTER TABLE zeprs.newborneval add column abnormalities_pulmonary tinyint(4);\n',NULL,197),(180,'2007-06-28 13:17:45','2007-06-28 13:29:39','S','ALTER TABLE zeprsdemo.newborneval add column abnormalities_pulmonary tinyint(4);\n',NULL,198),(181,'2007-06-28 13:19:18','2007-06-28 13:29:39','S','ALTER TABLE zeprs.newborneval add column abnormalities_pulmonary_comment VARCHAR(255);\n',NULL,199),(182,'2007-06-28 13:19:18','2007-06-28 13:29:39','S','ALTER TABLE zeprsdemo.newborneval add column abnormalities_pulmonary_comment VARCHAR(255);\n',NULL,200),(183,'2007-06-28 13:19:46','2007-06-28 13:29:39','S','ALTER TABLE zeprs.newborneval add column abnormalities_musculoskeletal tinyint(4);\n',NULL,201),(184,'2007-06-28 13:19:46','2007-06-28 13:29:39','S','ALTER TABLE zeprsdemo.newborneval add column abnormalities_musculoskeletal tinyint(4);\n',NULL,202),(185,'2007-06-28 13:20:13','2007-06-28 13:29:39','S','ALTER TABLE zeprs.newborneval add column abnormalities_musculoskeletal_comment VARCHAR(255);\n',NULL,203),(186,'2007-06-28 13:20:13','2007-06-28 13:29:39','S','ALTER TABLE zeprsdemo.newborneval add column abnormalities_musculoskeletal_comment VARCHAR(255);\n',NULL,204),(187,'2007-06-28 13:20:36','2007-06-28 13:29:39','S','ALTER TABLE zeprs.newborneval add column abnormalities_gastrointestinal tinyint(4);\n',NULL,205),(188,'2007-06-28 13:20:36','2007-06-28 13:29:39','S','ALTER TABLE zeprsdemo.newborneval add column abnormalities_gastrointestinal tinyint(4);\n',NULL,206),(189,'2007-06-28 13:21:03','2007-06-28 13:29:40','S','ALTER TABLE zeprs.newborneval add column abnormalities_gastrointestinal_comment VARCHAR(255);\n',NULL,207),(190,'2007-06-28 13:21:03','2007-06-28 13:29:40','S','ALTER TABLE zeprsdemo.newborneval add column abnormalities_gastrointestinal_comment VARCHAR(255);\n',NULL,208),(191,'2007-06-28 16:52:20','2007-06-29 09:47:18','S','alter table newborneval CHANGE abnormalities_pulmonary anomalies_pulmonary int(11);\r',NULL,209),(192,'2007-06-28 16:52:20','2007-06-29 09:47:19','S','alter table newborneval CHANGE abnormalities_musculoskeletal anomalies_musculoskeletal int(11);\r',NULL,210),(193,'2007-06-28 16:52:20','2007-06-29 09:47:19','S','alter table newborneval CHANGE abnormalities_gastrointestinal anomalies_gastrointestinal int(11);\r',NULL,211),(194,'2007-06-28 16:52:20','2007-06-29 09:47:19','S','alter table newborneval CHANGE abnormalities_pulmonary_comment anomalies_pulmonary_comment int(11);\r',NULL,212),(195,'2007-06-28 16:52:20','2007-06-29 09:47:19','S','alter table newborneval CHANGE abnormalities_musculoskeletal_comment anomalies_musculoskeletal_comment int(11);\r',NULL,213),(196,'2007-06-28 16:52:20','2007-06-29 09:47:19','S','alter table newborneval CHANGE abnormalities_gastrointestinal_comment anomalies_gastrointestinal_comment int(11);',NULL,214),(197,'2007-06-29 12:45:38','2007-06-29 14:35:53','S','ALTER TABLE zeprs.newborneval add column anomalies_orofacial int(11);\n',NULL,215),(198,'2007-06-29 12:45:38','2007-06-29 14:35:54','S','ALTER TABLE zeprsdemo.newborneval add column anomalies_orofacial int(11);\n',NULL,216),(199,'2007-06-29 12:49:10','2007-06-29 14:35:54','S','ALTER TABLE zeprs.newborneval add column anomalies_orofacial_comment VARCHAR(255);\n',NULL,217),(200,'2007-06-29 12:49:10','2007-06-29 14:35:54','S','ALTER TABLE zeprsdemo.newborneval add column anomalies_orofacial_comment VARCHAR(255);\n',NULL,218),(201,'2007-06-29 13:58:18','2007-06-29 14:35:54','S','delete from admin.field_enumeration where id = 1902;\r',NULL,219),(202,'2007-06-29 13:58:18','2007-06-29 14:35:54','S','delete from admin.field_enumeration where id = 2028;\r',NULL,220),(203,'2007-06-29 13:58:18','2007-06-29 14:35:54','S','delete from admin.field_enumeration where id = 2132;\r',NULL,221),(204,'2007-06-29 13:58:18','2007-06-29 14:35:54','S','delete from admin.field_enumeration where id = 2679;',NULL,222),(205,'2007-07-02 18:36:43','2007-07-02 18:38:53','S','alter table newborneval CHANGE anomalies_pulmonary_comment anomalies_pulmonary_comment VARCHAR(255);\r',NULL,223),(206,'2007-07-02 18:36:44','2007-07-02 18:38:53','S','alter table newborneval CHANGE anomalies_musculoskeletal_comment anomalies_musculoskeletal_comment VARCHAR(255);\r',NULL,224),(207,'2007-07-02 18:36:44','2007-07-02 18:38:53','S','alter table newborneval CHANGE anomalies_gastrointestinal_comment anomalies_gastrointestinal_comment VARCHAR(255);',NULL,225),(208,'2007-07-03 15:12:18','2007-07-03 15:53:18','S','alter table newborneval change baby_received_arv baby_received_arv int(11);\r',NULL,226),(209,'2007-07-03 15:12:18','2007-07-03 15:53:18','S','alter table infantdischargesummary change baby_received_arv baby_received_arv int(11);\r',NULL,227),(210,'2007-07-03 15:12:18','2007-07-03 15:53:18','S','update newborneval set baby_received_arv = 3151 where baby_received_arv = 1;\r',NULL,228),(211,'2007-07-03 15:12:18','2007-07-03 15:53:18','S','update newborneval set baby_received_arv = 3155 where baby_received_arv = 0;\r',NULL,229),(212,'2007-07-03 15:12:18','2007-07-03 15:53:18','S','update infantdischargesummary set baby_received_arv = 3151 where baby_received_arv = 1;\r',NULL,230),(213,'2007-07-03 15:12:18','2007-07-03 15:53:18','S','update infantdischargesummary set baby_received_arv = 3155 where baby_received_arv = 0;',NULL,231),(214,'2007-07-03 17:49:26','2007-07-03 18:13:08','S','alter table zeprs.newborneval change baby_received_arv baby_received_arv int(11);\r',NULL,232),(215,'2007-07-03 17:49:26','2007-07-03 18:13:08','S','alter table zeprs.infantdischargesummary change baby_received_arv baby_received_arv int(11);\r',NULL,233),(216,'2007-07-03 17:49:26','2007-07-03 18:13:08','S','update zeprs.newborneval set baby_received_arv = 3151 where baby_received_arv = 1;\r',NULL,234),(217,'2007-07-03 17:49:26','2007-07-03 18:13:09','S','update zeprs.newborneval set baby_received_arv = 3155 where baby_received_arv = 0;\r',NULL,235),(218,'2007-07-03 17:49:26','2007-07-03 18:13:09','S','update zeprs.infantdischargesummary set baby_received_arv = 3151 where baby_received_arv = 1;\r',NULL,236),(219,'2007-07-03 17:49:26','2007-07-03 18:13:09','S','update zeprs.infantdischargesummary set baby_received_arv = 3155 where baby_received_arv = 0;',NULL,237),(220,'2007-07-03 17:50:39','2007-07-03 18:13:10','S','alter table zeprs.newborneval CHANGE anomalies_musculoskeletal_comment anomalies_musculoskeletal_comment VARCHAR(255);  	\r',NULL,238),(221,'2007-07-03 17:50:39','2007-07-03 18:13:11','S','alter table zeprs.newborneval CHANGE anomalies_gastrointestinal_comment anomalies_gastrointestinal_comment VARCHAR(255); 	\r',NULL,239),(222,'2007-07-03 17:50:39','2007-07-03 18:13:12','S','alter table zeprs.newborneval CHANGE anomalies_pulmonary_comment anomalies_pulmonary_comment VARCHAR(255);',NULL,240),(223,'2007-07-11 11:47:38','2007-07-11 12:22:57','S','ALTER TABLE zeprs.patient DROP FOREIGN KEY FKD0D3EB057D2B7913; \r',NULL,241),(224,'2007-07-11 11:47:38','2007-07-11 12:23:05','S','ALTER TABLE zeprs.patient ADD CONSTRAINT FKD0D3EB057D2B7913 FOREIGN KEY (`site_id`) REFERENCES `site` (`id`) ON UPDATE CASCADE;',NULL,242),(225,'2007-07-11 11:48:55','2007-07-11 12:23:05','S','ALTER TABLE zeprsdemo.patient DROP FOREIGN KEY FKD0D3EB057D2B7913; \r',NULL,243),(226,'2007-07-11 11:48:55','2007-07-11 12:23:05','S','ALTER TABLE zeprsdemo.patient ADD CONSTRAINT FKD0D3EB057D2B7913 FOREIGN KEY (`site_id`) REFERENCES `site` (`id`) ON UPDATE CASCADE;',NULL,244),(227,'2007-07-15 11:41:57','2007-07-15 12:16:56','S','ALTER TABLE zeprs.testck2 add column fruits int(11);\n',NULL,245),(228,'2007-07-15 11:41:57','2007-07-15 12:16:56','S','ALTER TABLE zeprsdemo.testck2 add column fruits int(11);\n',NULL,246),(229,'2007-07-15 14:28:41','2007-07-15 14:32:56','S','ALTER TABLE zeprs.testck2 add column meats int(11);\n',NULL,247),(230,'2007-07-15 14:28:41','2007-07-15 14:32:57','S','ALTER TABLE zeprsdemo.testck2 add column meats int(11);\n',NULL,248),(231,'2007-07-15 14:34:21','2007-07-15 14:53:17','S','ALTER TABLE zeprs.testck2 add column teeta int(11);\n',NULL,249),(232,'2007-07-15 14:34:21','2007-07-15 14:53:17','S','ALTER TABLE zeprsdemo.testck2 add column teeta int(11);\n',NULL,250),(233,'2007-07-16 07:42:14','2007-07-16 08:01:06','S','ALTER TABLE zeprs.testck2 add column surfaces int(11);\n',NULL,251),(234,'2007-07-16 07:42:14','2007-07-16 08:01:06','S','ALTER TABLE zeprsdemo.testck2 add column surfaces int(11);\n',NULL,252),(235,'2007-07-16 08:07:15','2007-07-16 08:09:05','S','ALTER TABLE zeprs.testck2 add column test1 int(11);\n',NULL,253),(236,'2007-07-16 08:07:15','2007-07-16 08:09:05','S','ALTER TABLE zeprsdemo.testck2 add column test1 int(11);\n',NULL,254),(237,'2007-07-16 13:28:51','2007-07-16 16:25:12','S','ALTER TABLE zeprsdemo.testck2 add column textField VARCHAR(255);\n',NULL,256),(238,'2007-07-16 13:28:51','2007-07-16 16:25:13','S','ALTER TABLE zeprs.testck2 add column textField VARCHAR(255);\n',NULL,255),(239,'2007-07-16 13:40:43','2007-07-16 16:25:13','S','ALTER TABLE zeprs.testck2 add column is_true tinyint(1);\n',NULL,257),(240,'2007-07-16 13:40:43','2007-07-16 16:25:13','S','ALTER TABLE zeprsdemo.testck2 add column is_true tinyint(1);\n',NULL,258),(241,'2007-07-16 13:41:21','2007-07-16 16:25:13','S','ALTER TABLE zeprs.testck2 add column is_really_true tinyint(1);\n',NULL,259),(242,'2007-07-16 13:41:21','2007-07-16 16:25:13','S','ALTER TABLE zeprsdemo.testck2 add column is_really_true tinyint(1);\n',NULL,260);
UNLOCK TABLES;
...
--
-- Table structure for table `field_enumeration`
--
...
CREATE TABLE `field_enumeration` (
  ...
  PRIMARY KEY  (`id`),
  KEY `FKC69A62823E8F4D64` (`last_modified_by`),
  KEY `FKC69A628251A3A90E` (`created_by`),
  KEY `FKC69A62827D2B7913` (`site_id`),
  KEY `FKC69A6282C8A07680` (`field_id`),
  CONSTRAINT `FKC69A62823E8F4D64` FOREIGN KEY (`last_modified_by`) REFERENCES `user_group_membership` (`id`),
  CONSTRAINT `FKC69A628251A3A90E` FOREIGN KEY (`created_by`) REFERENCES `user_group_membership` (`id`),
  CONSTRAINT `FKC69A62827D2B7913` FOREIGN KEY (`site_id`) REFERENCES `site` (`id`),
  CONSTRAINT `FKC69A6282C8A07680` FOREIGN KEY (`field_id`) REFERENCES `form_field` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `field_enumeration`
--


/*!40000 ALTER TABLE `field_enumeration` DISABLE KEYS */;
LOCK TABLES `field_enumeration` WRITE;
UNLOCK TABLES;
/*!40000 ALTER TABLE `field_enumeration` ENABLE KEYS */;
...
CREATE TABLE `form` (
  ...
  `require_reauth` bit(1) NOT NULL,
  `require_patient` bit(1) NOT NULL,
  `is_enabled` bit(1) NOT NULL,
  `last_modified` datetime default NULL,
  `created` datetime default NULL,
  `last_modified_by` varchar(255) default NULL,
  ...
  `flow_order` int(11) default NULL,
  `form_type_id` bigint(20) default NULL,
  `max_submissions` int(11) default NULL,
  PRIMARY KEY  (`id`),
  KEY `FK300CC451A3A90E` (`created_by`),
  KEY `FK300CC43E8F4D64` (`last_modified_by`),
  KEY `FK300CC47D2B7913` (`site_id`),
  CONSTRAINT `FK300CC43E8F4D64` FOREIGN KEY (`last_modified_by`) REFERENCES `user_group_membership` (`id`),
  CONSTRAINT `FK300CC451A3A90E` FOREIGN KEY (`created_by`) REFERENCES `user_group_membership` (`id`),
  CONSTRAINT `FK300CC47D2B7913` FOREIGN KEY (`site_id`) REFERENCES `site` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Table structure for table `form42`
--

DROP TABLE IF EXISTS `form42`;
CREATE TABLE `form42` (
  `id` bigint(20) NOT NULL default '0',
  `miscarriage` int(11) default NULL,
  `diagnosis_on_933` text,
  `surgical_tre_934` int(11) default NULL,
  `surgical_tre_935` text,
  `medical_trea_936` int(11) default NULL,
  `medical_trea_937` text,
  `testValue1` int(11) default NULL,
  `testValue2` int(11) default NULL,
  `testValue3` int(11) default NULL,
  PRIMARY KEY  (`id`),
  KEY `FKB45FF242D1B` (`id`),
  CONSTRAINT `FKB45FF242D1B` FOREIGN KEY (`id`) REFERENCES `encounter` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `form42`
--


/*!40000 ALTER TABLE `form42` DISABLE KEYS */;
LOCK TABLES `form42` WRITE;
UNLOCK TABLES;
/*!40000 ALTER TABLE `form42` ENABLE KEYS */;
...
CREATE TABLE `form_field` (
  ...
  `star_schema_name` varchar(255) default NULL,
  `encounter_record_property` varchar(255) NOT NULL,
  `patient_status_property` varchar(255) default NULL,
  `patient_lab_property` varchar(255) default NULL,
  PRIMARY KEY  (`id`),
  KEY `FKF276DBF7D2B7913` (`site_id`),
  KEY `FKF276DBF3E8F4D64` (`last_modified_by`),
  KEY `FKF276DBF51A3A90E` (`created_by`),
  CONSTRAINT `FKF276DBF3E8F4D64` FOREIGN KEY (`last_modified_by`) REFERENCES `user_group_membership` (`id`),
  CONSTRAINT `FKF276DBF51A3A90E` FOREIGN KEY (`created_by`) REFERENCES `user_group_membership` (`id`),
  CONSTRAINT `FKF276DBF7D2B7913` FOREIGN KEY (`site_id`) REFERENCES `site` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `form_type` (
  ...
  `site_id` bigint(20) default NULL,
  PRIMARY KEY  (`id`),
  KEY `FK6BDE95D57D2B7913` (`site_id`),
  KEY `FK6BDE95D53E8F4D64` (`last_modified_by`),
  KEY `FK6BDE95D551A3A90E` (`created_by`),
  CONSTRAINT `FK6BDE95D53E8F4D64` FOREIGN KEY (`last_modified_by`) REFERENCES `user_group_membership` (`id`),
  CONSTRAINT `FK6BDE95D551A3A90E` FOREIGN KEY (`created_by`) REFERENCES `user_group_membership` (`id`),
  CONSTRAINT `FK6BDE95D57D2B7913` FOREIGN KEY (`site_id`) REFERENCES `site` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Table structure for table `live_report`
--
...
CREATE TABLE `live_report` (
  ...
  `site_id` bigint(20) default NULL,
  PRIMARY KEY  (`id`),
  KEY `FKBFB8FFE77D2B7913` (`site_id`),
  KEY `FKBFB8FFE73E8F4D64` (`last_modified_by`),
  KEY `FKBFB8FFE751A3A90E` (`created_by`),
  CONSTRAINT `FKBFB8FFE73E8F4D64` FOREIGN KEY (`last_modified_by`) REFERENCES `user_group_membership` (`id`),
  CONSTRAINT `FKBFB8FFE751A3A90E` FOREIGN KEY (`created_by`) REFERENCES `user_group_membership` (`id`),
  CONSTRAINT `FKBFB8FFE77D2B7913` FOREIGN KEY (`site_id`) REFERENCES `site` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `live_report`
--


/*!40000 ALTER TABLE `live_report` DISABLE KEYS */;
LOCK TABLES `live_report` WRITE;
UNLOCK TABLES;
/*!40000 ALTER TABLE `live_report` ENABLE KEYS */;

--
-- Table structure for table `live_report_field`
--

DROP TABLE IF EXISTS `live_report_field`;
CREATE TABLE `live_report_field` (
  `id` bigint(20) NOT NULL auto_increment,
  `live_report_id` bigint(20) default NULL,
  `form_id` bigint(20) default NULL,
  `page_item_id` bigint(20) default NULL,
  `form_field_id` bigint(20) default NULL,
  `report_property` varchar(255) default NULL,
  ...
  `site_id` bigint(20) default NULL,
  PRIMARY KEY  (`id`),
  KEY `FKCE683AA2D79EFE76` (`form_id`),
  KEY `FKCE683AA2F99D1473` (`live_report_id`),
  KEY `FKCE683AA27D5DB79B` (`form_field_id`),
  KEY `FKCE683AA27D2B7913` (`site_id`),
  KEY `FKCE683AA251A3A90E` (`created_by`),
  KEY `FKCE683AA23E8F4D64` (`last_modified_by`),
  KEY `FKCE683AA29B9EC417` (`page_item_id`),
  CONSTRAINT `FKCE683AA23E8F4D64` FOREIGN KEY (`last_modified_by`) REFERENCES `user_group_membership` (`id`),
  CONSTRAINT `FKCE683AA251A3A90E` FOREIGN KEY (`created_by`) REFERENCES `user_group_membership` (`id`),
  CONSTRAINT `FKCE683AA27D2B7913` FOREIGN KEY (`site_id`) REFERENCES `site` (`id`),
  CONSTRAINT `FKCE683AA27D5DB79B` FOREIGN KEY (`form_field_id`) REFERENCES `form_field` (`id`),
  CONSTRAINT `FKCE683AA29B9EC417` FOREIGN KEY (`page_item_id`) REFERENCES `page_item` (`id`),
  CONSTRAINT `FKCE683AA2D79EFE76` FOREIGN KEY (`form_id`) REFERENCES `form` (`id`),
  CONSTRAINT `FKCE683AA2F99D1473` FOREIGN KEY (`live_report_id`) REFERENCES `live_report` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `live_report_field`
--


/*!40000 ALTER TABLE `live_report_field` DISABLE KEYS */;
LOCK TABLES `live_report_field` WRITE;
UNLOCK TABLES;
/*!40000 ALTER TABLE `live_report_field` ENABLE KEYS */;

--
-- Table structure for table `live_report_form`
--

DROP TABLE IF EXISTS `live_report_form`;
CREATE TABLE `live_report_form` (
  `id` bigint(20) NOT NULL auto_increment,
  `live_report_id` bigint(20) default NULL,
  `form_id` bigint(20) default NULL,
  `last_modified` datetime default NULL,
  ...
  `site_id` bigint(20) default NULL,
  PRIMARY KEY  (`id`),
  KEY `FK6A89E1CF99D1473` (`live_report_id`),
  KEY `FK6A89E1C7D2B7913` (`site_id`),
  KEY `FK6A89E1CD79EFE76` (`form_id`),
  KEY `FK6A89E1C51A3A90E` (`created_by`),
  KEY `FK6A89E1C3E8F4D64` (`last_modified_by`),
  CONSTRAINT `FK6A89E1C3E8F4D64` FOREIGN KEY (`last_modified_by`) REFERENCES `user_group_membership` (`id`),
  CONSTRAINT `FK6A89E1C51A3A90E` FOREIGN KEY (`created_by`) REFERENCES `user_group_membership` (`id`),
  CONSTRAINT `FK6A89E1C7D2B7913` FOREIGN KEY (`site_id`) REFERENCES `site` (`id`),
  CONSTRAINT `FK6A89E1CD79EFE76` FOREIGN KEY (`form_id`) REFERENCES `form` (`id`),
  CONSTRAINT `FK6A89E1CF99D1473` FOREIGN KEY (`live_report_id`) REFERENCES `live_report` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `live_report_form`
--


/*!40000 ALTER TABLE `live_report_form` DISABLE KEYS */;
LOCK TABLES `live_report_form` WRITE;
UNLOCK TABLES;
/*!40000 ALTER TABLE `live_report_form` ENABLE KEYS */;
...
CREATE TABLE `page_item` (
  ...
  `visible_enum_id_trigger1` varchar(255) default NULL,
  `visible_dependencies1` varchar(255) default NULL,
  `visible_enum_id_trigger2` varchar(255) default NULL,
  `visible_dependencies2` varchar(255) default NULL,
  `selected_enum` bigint(20) default NULL,
  `form_id` bigint(20) default NULL,
  `colspan` int(11) default NULL,
  `highlight` tinyint(1) default NULL,
  PRIMARY KEY  (`id`),
  KEY `FK34AA12C33E8F4D64` (`last_modified_by`),
  KEY `FK34AA12C37D2B7913` (`site_id`),
  KEY `FK34AA12C3D79EFE76` (`form_id`),
  KEY `FK34AA12C37D5DB79B` (`form_field_id`),
  KEY `FK34AA12C351A3A90E` (`created_by`),
  CONSTRAINT `FK34AA12C33E8F4D64` FOREIGN KEY (`last_modified_by`) REFERENCES `user_group_membership` (`id`),
  CONSTRAINT `FK34AA12C351A3A90E` FOREIGN KEY (`created_by`) REFERENCES `user_group_membership` (`id`),
  CONSTRAINT `FK34AA12C37D2B7913` FOREIGN KEY (`site_id`) REFERENCES `site` (`id`),
  CONSTRAINT `FK34AA12C37D5DB79B` FOREIGN KEY (`form_field_id`) REFERENCES `form_field` (`id`),
  CONSTRAINT `FK34AA12C3D79EFE76` FOREIGN KEY (`form_id`) REFERENCES `form` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Table structure for table `pringle`
--

DROP TABLE IF EXISTS `pringle`;
CREATE TABLE `pringle` (
  `id` bigint(20) NOT NULL default '0',
  `rhodope` int(11) default NULL,
  `condition_of_foetus_964` int(11) default NULL,
  PRIMARY KEY  (`id`),
  KEY `FKpringle` (`id`),
  CONSTRAINT `FKpringle` FOREIGN KEY (`id`) REFERENCES `encounter` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `pringle`
--


/*!40000 ALTER TABLE `pringle` DISABLE KEYS */;
LOCK TABLES `pringle` WRITE;
UNLOCK TABLES;
/*!40000 ALTER TABLE `pringle` ENABLE KEYS */;
...
--
-- Table structure for table `referral_outcome`
--
...
CREATE TABLE `referral_outcome` (
  ...
  `transport` int(11) default NULL,
  PRIMARY KEY  (`id`),
  KEY `FK20D73CB0D1B` (`id`),
  CONSTRAINT `FK20D73CB0D1B` FOREIGN KEY (`id`) REFERENCES `outcome` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `referral_outcome`
--


/*!40000 ALTER TABLE `referral_outcome` DISABLE KEYS */;
LOCK TABLES `referral_outcome` WRITE;
UNLOCK TABLES;
/*!40000 ALTER TABLE `referral_outcome` ENABLE KEYS */;
...
--
-- Table structure for table `testb1`
--

DROP TABLE IF EXISTS `testb1`;
CREATE TABLE `testb1` (
  `id` bigint(20) NOT NULL default '0',
  `one` varchar(255) default NULL,
  `two` int(11) default NULL,
  `three` date default NULL,
  PRIMARY KEY  (`id`),
  KEY `FKtestb1` (`id`),
  CONSTRAINT `FKtestb1` FOREIGN KEY (`id`) REFERENCES `encounter` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `testb1`
--


/*!40000 ALTER TABLE `testb1` DISABLE KEYS */;
LOCK TABLES `testb1` WRITE;
UNLOCK TABLES;
/*!40000 ALTER TABLE `testb1` ENABLE KEYS */;

--
-- Table structure for table `testb2`
--

DROP TABLE IF EXISTS `testb2`;
CREATE TABLE `testb2` (
  `id` bigint(20) NOT NULL default '0',
  `one` varchar(255) default NULL,
  `two` int(11) default NULL,
  ...
  PRIMARY KEY  (`id`),
  KEY `FKtestb2` (`id`),
  CONSTRAINT `FKtestb2` FOREIGN KEY (`id`) REFERENCES `encounter` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `testb2`
--


/*!40000 ALTER TABLE `testb2` DISABLE KEYS */;
LOCK TABLES `testb2` WRITE;
UNLOCK TABLES;
/*!40000 ALTER TABLE `testb2` ENABLE KEYS */;
...
CREATE TABLE `testck4` (
  `id` bigint(20) NOT NULL default '0',
  `first_feild` varchar(255) default NULL,
  PRIMARY KEY  (`id`),
  KEY `FKtestCK4` (`id`),
...
CREATE TABLE `testform` (
  ...
  `enumfield` int(11) default NULL,
  `enumerama` varchar(255) default NULL,
  `anotherenum` varchar(255) default NULL,
  `testRow` varchar(255) default NULL,
  `teflon` varchar(255) default NULL,
  `thrombo` varchar(255) default NULL,
  `abdomen_172` int(11) default NULL,
  `abruptia_placenta` int(11) default NULL,
  `urinalysis_ace_244` int(11) default NULL,
  `adequacy_of_pelvic_348` int(11) default NULL,
  `adnexa_189` int(11) default NULL,
  `adnexa_abnormal_190` varchar(255) default NULL,
  PRIMARY KEY  (`id`),
  KEY `FKBBADB856D1B` (`id`),
  CONSTRAINT `FKBBADB856D1B` FOREIGN KEY (`id`) REFERENCES `encounter` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
/*!40000 ALTER TABLE `testform` DISABLE KEYS */;
LOCK TABLES `testform` WRITE;
UNLOCK TABLES;
/*!40000 ALTER TABLE `testform` ENABLE KEYS */;
