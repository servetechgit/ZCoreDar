...
<script type='text/javascript' src='/${appName}/dwr/interface/Newborn.js;jsessionid=${pageContext.request.session.id}'></script>
...
<input type="hidden" name="pregnancyId" id="pregnancyId" value="${eventId}"/>
...
<table width="100%" id="tbl99999999">
    ...
    <tr>
        <td>
        <a href="javascript://" onclick="showCalendar('${yearnow}','${monthnow}','${datenow}','dd/MM/yyyy','${encounterForm.classname}','newbornDateField',event, ${lastTwoYears},${twoYears});">
        <img alt="Select Date" border="0" src="/${appName}/images/calendar.gif" align="middle">&nbsp;&nbsp;</a><span id="spannewbornDateField" class="dateDisplay">${nicedateVisit}</span>
...
<script type='text/javascript'>
    // Newborn.createResponse(fillForm, ${patientId}, ${eventId});
