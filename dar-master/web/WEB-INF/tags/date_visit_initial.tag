...
<table border="0" cellpadding="4" cellspacing="2" id="tbl" summary="1 col table"  class="formTable">
    <tr class="sectionHeader"><td><span class="sectionHeader"><bean:message bundle="ApplicationResources" key="form.dateOfVisit"/>:</span><span class="asterix">*</span></td>
    <td valign="top" class="defaultCell">
 <a href="javascript://" onclick="showCalendar('${yearnow}','${monthnow}','${datenow}','dd MMM yy','${encounterForm.classname}','date_visit',event,${lastTwoYears},${twoYears},'date_visit');">
    ...
    <html:hidden styleClass="disabled-date" onfocus="this.blur()" property="date_visit" value="${yearnow}-${monthnow}-${datenow}"/>
    </td>
    </tr>
</table>