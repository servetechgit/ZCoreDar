...
<script type='text/javascript' src='/${appName}/dwr/interface/Fetus.js;jsessionid=${pageContext.request.session.id}'></script>
...
<c:if test="${! empty encounterId}">Fetus.createResponse(fillFetusForm, ${examSequence}, ${patientId}, ${eventId});</c:if>
