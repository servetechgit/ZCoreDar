...
<c:set var="sixtyYears" value="${yearnow - 60}"/>
    <a href="javascript://" onclick="showCalendar('${yearnow}','${monthnow}','${datenow}','dd MMM yy','${element}','${classId}',event,${lastTwoYears},${twoYears});">
    <img alt="Select Date" border="0" src="/${appName}/images/calendar.gif" align="middle"></a>&nbsp;&nbsp;<span id="span${classId}" class="dateDisplay">${nicedateVisit}</span>
