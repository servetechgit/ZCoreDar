...
<c:choose>
    ...
    <input type="text" size="${pageItem.size}" maxlength="${pageItem.maxlength}" name="${field.identifier}${pos}" id="${field.identifier}Field${pos}" onchange="insertInputField('${remoteClass}', ${scriptName}, '${classname}','${field.identifier}', ${pos},'${field.identifier}Field${pos}',${patientId}, ${eventId},'${user}',${siteId},${formId})"  style="display:none;"/>
    </c:when>
    <c:otherwise>
    <span id="${field.identifier}Results${pos}"></span>
    <input type="text" size="${pageItem.size}" maxlength="${pageItem.maxlength}" name="${field.identifier}${pos}" id="${field.identifier}Field${pos}" onchange="insertInputField('${remoteClass}', ${scriptName}, '${classname}','${field.identifier}', ${pos},'${field.identifier}Field${pos}',${patientId}, ${eventId},'${user}',${siteId},${formId})"/>
    </c:otherwise>
</c:choose>
