...
<template:put name='content' direct='true'>
    ...
    <table>
        <tr>
            <td valign="top"><bean:message bundle="ApplicationResources" key="labels.admin.enumeration.enumeration"/>: </td>
            <td valign="top"><html:text property="enumeration" /></td>
        </tr>
        <tr>
            <td valign="top"><bean:message bundle="ApplicationResources" key="labels.admin.enumeration.numericValue"/>: </td>
            <td valign="top"><html:text property="numericValue" /></td>
        </tr>
        <tr>
            <td valign="top"><bean:message bundle="ApplicationResources" key="labels.admin.enumeration.enabled"/>: </td>
            <td valign="top"><html:checkbox property="enabled"/></td>
        </tr>
        <tr>
            <td valign="top" align="right" colspan="2">
            <html:submit value="Save" onclick="bCancel=false;"/>
            <html:javascript formName="adminEnumeration" dynamicJavascript="true" staticJavascript="false" bundle="ApplicationResources"/>
            </html:form></td>
        </tr>
    </table>
</template:put>
