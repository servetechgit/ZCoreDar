        ...
        <logic:present name="tasks" scope="request">
            ...
            <c:if test="${task.flowId ==encounterForm.flow.id}">
                ...
                <c:when test="${task.active=='true'}">
                    <c:choose>
                        <c:when test="${task.formId == 80}">
                            <tr>
                                <td><html:link action="/patientAnte.do" styleClass="noBorder"><img src="/${appName}/images/checkbox.gif" height="15px" width="15px"/></html:link></td>
                        ...
                        <c:when test="${task.formId == 4}">
                            <tr>
                                <td><html:link action="/patientSafeMother.do" styleClass="noBorder"><img src="/${appName}/images/checkbox.gif" height="15px" width="15px"/></html:link></td>
                        ...
                        <c:otherwise>
                            <tr>
                                <td><img src="/${appName}/images/checkbox.gif" height="15px" width="15px"/></td>
                ...
                <c:choose>
                    ...
                    <tr>
                        <td><img src="/${appName}/images/checkboxChecked.gif" height="15px" width="15px"/></td>
