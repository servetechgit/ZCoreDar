                    ...
                    <c:choose>
                        <c:when test="${! empty drugsDispensed}">
                            <logic:notEmpty name="drugsDispensed" property="timeObservation${pos}">
                                ...
                                <br/>
                                <input type="button" name="_add" value="Done" onclick="insertDrugsDispensed(${pos},'timeObservationField${pos}', 'DrugsDispensed', 'timeObservation', replyTimeObservation, ${zeprs_session.sessionPatient.id}, ${zeprs_session.sessionPatient.currentEventId},'${user}',${siteId}); toggle2('timeObservationSpan${pos}')">
                                </span>
                            </logic:notEmpty>
                                                ...
                                                <table>
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <p><input type="button" name="_add" value="Save" onclick="insertDrugsDispensed(${pos},'drugsDispensed${pos}', 'DrugsDispensed', 'drugsDispensed', replyDrugsDispensed, ${zeprs_session.sessionPatient.id}, ${zeprs_session.sessionPatient.currentEventId},'${user}',${siteId})">
                                                            </p>
                                                        </td>
                                                    </tr>
                                                </table>
