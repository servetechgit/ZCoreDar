    ...
    <c:forEach var="item" varStatus="loop"  begin="${startRow}" end="${stopRow}">
        <c:set var="pos" value="${loop.index}"/>
            ...
            <logic:notEmpty name="oxytocin" property="oxytocin${pos}">
                ...
                <div id="property${pos}"><input type="text" name="oxytocin${pos}" id="oxytocinField${pos}" onchange="insertOxytocin(${pos},'oxytocinField${pos}',${zeprs_session.sessionPatient.id}, ${zeprs_session.sessionPatient.currentEventId},'${user}',${siteId})" style="display:none;" size="3" maxlength="4">
                </div>
            </logic:notEmpty>
            <logic:empty name="oxytocin" property="oxytocin${pos}">
                <div id="oxytocinValue${pos}"></div>
                <div id="property${pos}"><input type="text" name="oxytocin${pos}" id="oxytocinField${pos}" onchange="insertOxytocin(${pos},'oxytocinField${pos}',${zeprs_session.sessionPatient.id}, ${zeprs_session.sessionPatient.currentEventId},'${user}',${siteId})" style="display:none;" size="3" maxlength="4"></div>
            </logic:empty>
            </td>
