    ...
    <c:forEach var="item" varStatus="loop"  begin="${startRowHour}" end="${stopRowHour}">
        <c:set var="pos" value="${loop.index}"/>
            ...
            <logic:notEmpty name="urineAmount" property="urineAmount${pos}">
                ...
                <div id="property${pos}"><input type="text" name="urineAmount${pos}" id="urineAmountField${pos}" onchange="insertUrineAmount(${pos},'urineAmountField${pos}',${zeprs_session.sessionPatient.id}, ${zeprs_session.sessionPatient.currentEventId},'${user}',${siteId})" style="display:none;" size="3" maxlength="4">
                </div>
            </logic:notEmpty>
            <logic:empty name="urineAmount" property="urineAmount${pos}">
                <div id="urineAmountValue${pos}"></div>
                <div id="property${pos}"><input type="text" name="urineAmount${pos}" id="urineAmountField${pos}" onchange="insertUrineAmount(${pos},'urineAmountField${pos}',${zeprs_session.sessionPatient.id}, ${zeprs_session.sessionPatient.currentEventId},'${user}',${siteId})" style="display:none;" size="3" maxlength="4"></div>
            </logic:empty>
            </td>
    </c:forEach>
    </c:when>
