    ...
    <c:forEach var="item" varStatus="loop"  begin="${startRowHour}" end="${stopRowHour}">
        <c:set var="pos" value="${loop.index}"/>
            ...
            <logic:notEmpty name="urinalysisAcetone" property="urinalysisAcetone${pos}">
                ...
                <div id="property${pos}">
                <select name="urinalysisAcetone${pos}" id="urinalysisAcetoneField${pos}" onchange="insertUrinalysisAcetone(${pos},'urinalysisAcetoneField${pos}',${zeprs_session.sessionPatient.id}, ${zeprs_session.sessionPatient.currentEventId},'${user}',${siteId})" style="display:none; border:none">
                    <option value="">--</option>
