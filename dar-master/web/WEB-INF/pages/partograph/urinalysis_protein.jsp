    ...
    <c:forEach var="item" varStatus="loop"  begin="${startRowHour}" end="${stopRowHour}">
        <c:set var="pos" value="${loop.index}"/>
            ...
            <logic:notEmpty name="urinalysisProtein" property="urinalysisProtein${pos}">
                ...
                <div id="property${pos}">
                <select name="urinalysisProtein${pos}" id="urinalysisProteinField${pos}" onchange="insertUrinalysisProtein(${pos},'urinalysisProteinField${pos}',${zeprs_session.sessionPatient.id}, ${zeprs_session.sessionPatient.currentEventId},'${user}',${siteId})" style="display:none; border:none">
                    <option value="">--</option>
