...
<%@ taglib uri="/WEB-INF/tlds/struts-bean.tld" prefix="bean" %>
        <c:choose>
           ...
           <c:otherwise>
                <zeprs:inline_select pageItem="${pageItem}" value="${thisValue}" dropdownSelectedEnumId="${dropdownSelectedEnumId}" renderedValue="${renderedValue}" encounterId="${encounterId}" onchange="${onchange}"  styleId="${inlineFieldIdentifier}${styleId}" inlineFieldIdentifier="${inlineFieldIdentifier}"/>
           </c:otherwise>
        </c:choose>
