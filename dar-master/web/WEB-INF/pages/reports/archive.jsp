...
<template:put name='title' content='Record Modification Listing' direct='true'/>
<template:put name='header' content='Record Modification Listing' direct='true'/>
<template:put name='content' direct='true'>
<div id="widePage4">
<p>Specify date range if searchng for all patients. Enter the Client ID to search for modifications to a client's records. If you do a search by Client ID, you do not need to specify a date range.</p>
...
--%>
            <td><a href='<c:out value="/${appName}/${url}"/>'><bean:write name="item" property="formLabel"/>, <bean:write name="item" property="dateVisit"/></a></td>
