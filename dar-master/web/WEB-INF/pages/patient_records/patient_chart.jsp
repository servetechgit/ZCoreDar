    ...
    <tbody>
        <tr>
            ...
            <logic:notEmpty name="patient" property="patientStatusreport">
                ...
                <a href='<c:out value="/${appName}/${url}"/>' title="Jump to this phase.">${patient.patientStatusreport.currentFlow.name}</a>
                </logic:notEmpty>
            </logic:notEmpty></td>
            <%--<td class="patientrow">
