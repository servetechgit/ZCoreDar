   ...
   <table class="enhancedtable" width="100%">
        ...
        <logic:notEmpty name="referrals">
            ...
            <logic:iterate id="referral" name="referrals">
                ...
                <tr>
                    <td width="50px"><a href='<c:out value="/${appName}/${encounter}"/>'><fmt:formatDate type="both" pattern="dd MMM yy" value="${referral.created}"/></a></td>
                    ...
                    <c:choose>
                        ...
                        <td colspan="3"><a href='<c:out value="/${appName}/${admitUrl}"/>'>Admit to UTH</a></td>
                        </c:when>
                        <c:when test="${empty referral.uthAdmissionDate && zeprs_session.clientSettings.site.siteTypeId != 2}">
                    ...
                    <c:choose>
                        ...
                        <td><a href='<c:out value="/${appName}/${dischargeUrl}"/>'>${referral.dischargeDate}</a></td>
                        </c:when>
                        <c:otherwise>
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <c:choose>
                                        <c:when test="${!empty zeprs_session.sessionPatient.parentId == true}">
                                            <td><a href='<c:out value="/${appName}/${nicuUrl}"/>'>NICU Discharge</a></td>
                                        </c:when>
                                        <c:when test="${zeprs_session.sessionPatient.deliveryCompleted == true}">
                                            <td><a href='<c:out value="/${appName}/${postnatalUrl}"/>'>Postnatal Discharge</a></td>
                                        </c:when>
                                        <c:otherwise>
                                            <td><a href='<c:out value="/${appName}/${antenatalUrl}"/>'>Antenatal Discharge</a></td>
                                        </c:otherwise>
                                    </c:choose>
                                </c:otherwise>
                            </c:choose>
