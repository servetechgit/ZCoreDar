...
<div id="probList${print}">
   <table class="enhancedtable" width="100%">
       ...
       <tr>
           <td colspan="2">
            <strong><a href='<c:out value="/${appName}/${probUrl}"/>'>Create New Problem</a></strong>
            </td>
       </tr>
       </c:if>
    </table>
        ...
        <c:choose>
                ...
                <c:when test="${problemId==thisproblem.id && outcome!=1}">
                    ...
                    <tr class="currentProblem">
                        ...
                        <td><fmt:formatDate type="both" pattern="dd MMM yy" value="${thisproblem.lastModified}"/>
                            <a href='<c:out value="/${appName}/${delProblemUrl}"/>'onclick="return confirm('Caution: Are you sure you want to delete this problem from ZEPRS?');self.close();" title="Delete this Problem">(X)</a>
                        </td>
                    </tr>
                </c:when>
                <c:otherwise>
            ...
            <c:when test="${thisproblem.class.name=='org.cidrz.webapp.dynasite.rules.impl.EncounterOutcome'}">
                ...
                <c:choose>
                    ...
                    <tr class="currentProblem">
                        <td><a href='<c:out value="/${appName}/${editUrl}"/>'>Required Form: ${currproblemName}</a></td>
                        <td width="50px"><html:link action="/viewEncounter" paramId="id" paramName="thisproblem" paramProperty="encounterId">
                            ...
                            <a href='<c:out value="/${appName}/${delOutcomeUrl}"/>'onclick="return confirm('Caution: Are you sure you want to delete this problem from ZEPRS?');self.close();" title="Delete this Problem">(X)</a>
                            </td>
                    </tr>
                    </c:when>
                    <c:otherwise>
