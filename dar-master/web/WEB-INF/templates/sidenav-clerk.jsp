...
<div id="sidebar-a">
    <div id="sidenavcontainer">
        <ul id="navlist">
            ...
            <li style="margin: 0px 0px 0px 5px;">&nbsp;</li>
            <li><html:link  href="/${appName}/reports.do">Reports</html:link></li>
            </logic:present>
            <li><html:link  href="/${appName}/referrals.do">Referrals</html:link></li>
            <li><html:link  href="/${appName}/help.do">Help</html:link></li>
            <li style="margin: 0px 0px 0px 5px;">&nbsp;</li>
       ...
       <li><a href='<%= response.encodeURL(printTemplateURL) %>'>Print Version</a></li>--%>
            ...
            <li style="margin: 0px 0px 0px 5px;">&nbsp;</li>
            <li><html:link  href="/${appName}/admin/home.do">Admin</html:link></li>
            </logic:present>
            <li><html:link  href="/${appName}/logout.do">Logout</html:link></li>
        </ul><!-- navlist -->
