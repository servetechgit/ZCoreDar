    ...
    <div id="loginStatus-print">
        ...
        <tbody>
            <tr>
                ...
                <td class="patientrow" width="150px" align="left"><fmt:formatDate type="both" pattern="dd/MM/yy" value="${now}" />&nbsp;<input type="text" id="pcTime" size="7" class="clock" onfocus="this.blur()"/></td>
                <td>&nbsp;</td>
            </tr>
        </tbody>
        </table>
