...
%>
    ...
    <c:url value="Appointment/new.do" var="appointments"><c:param name="patientId" value="${zeprs_session.sessionPatient.id}"/></c:url>
    <c:url value="PatientStatus_changes/new.do" var="patient_status"><c:param name="patientId" value="${zeprs_session.sessionPatient.id}"/></c:url>
    <c:url value="ArtRegimen/new.do" var="artRegimen"><c:param name="patientId" value="${zeprs_session.sessionPatient.id}"/></c:url>
