...
<html>
    ...
    <div id="loginStatus-print">
        ...
        <tbody>
            <tr>
                <td class="patientrow" width="260px" align="left">${zeprs_session.fullname}</td>
                <td class="patientrow" width="150px" align="left"><fmt:formatDate type="both" pattern="dd MMM yy" value="${now}" />&nbsp;<input type="text" id="pcTime" size="7" class="clock" onfocus="this.blur()"/></td>
                <td>&nbsp;</td>
            </tr>
        </tbody>
        </table>
    ...
    <div id="sidebar-a-print">
        <div id="sidenavcontainer">
            <ul id="navlist">
                ...
                <li><html:link action="PatientRegistration/new.do" onclick="alert('Please ensure that you have searched for this patient before creating a new record.');">New Patient</html:link></li>
                <li style="margin: 0px 0px 0px 5px;">&nbsp;</li>
                </logic:present>
                <logic:present role="VIEW_SELECTED_REPORTS_AND_VIEW_STATISTICAL_SUMMARIES">
                <li><html:link action="/reports">Reports</html:link></li>
                </logic:present>
                <c:url value="admin/records/list.do" var="stock_control"><c:param name="formId" value="161"/><c:param name="maxRows" value="20"/></c:url>
