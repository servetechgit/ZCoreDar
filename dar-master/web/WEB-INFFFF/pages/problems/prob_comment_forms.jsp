...
<div id="probForms">
    <c:choose>
         <c:when test="${param.mode=='create'}">
            ...
            <html:hidden property="eventId" value="${zeprs_session.sessionPatient.currentEventId}"/>
            <div class="row">
...
<script type="text/javascript" language="Javascript1.1" src="/${appName}/js/validateProbs.js">
</script>
<script type="text/javascript" language="Javascript1.1" src="/${appName}/js/validateComment.js">
</script>
<%--<html:javascript formName="problem" src="/${appName}/js/validateProbs.js" dynamicJavascript="false" staticJavascript="true" />

<html:javascript formName="comment" src="/${appName}/js/validateOutcomes.js" dynamicJavascript="false" staticJavascript="true" />--%>
