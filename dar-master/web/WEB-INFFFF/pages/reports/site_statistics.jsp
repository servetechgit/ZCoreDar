...
<div id="forms">
	<h2>New and Active Clients</h2>
	<p>New Clients: from period ${beginDate} - ${endDate}</p>
	<p>Active clients: Clients who have had drugs dispensed in the past three months.</p>
	<table class="enhancedtable">
		<tbody>
			<tr>
				<th id="adds" class="enhancedtabletighterCell" valign="middle"><strong>New Clients</strong></th>
				<th id="adds" class="enhancedtabletighterCell" valign="middle"><strong>Active Clients</strong></th>
			</tr>
			<tr>
	...
	<h2>OI Patients: ${beginDate} - ${endDate}</h2>
	<p>Patients who have had stock other than Single drugs, Paediatric Single drugs, or FDC's dispensed and who do not have a regimen.</p>
	<table class="enhancedtable">
		<tbody>
			<tr>
				<th id="adds" class="enhancedtabletighterCell" valign="middle"><strong>OI Patients</strong></th>
			</tr>
			<tr>
				<td>${register.stats.oiPatients}</td>
			</tr>
		</tbody>
	</table>
	<p>&nbsp;</p>
