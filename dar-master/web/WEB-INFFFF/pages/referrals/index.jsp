...
<c:choose>
    ...
    <c:otherwise>
    <c:set var="template" value="/WEB-INF/templates/${appTemplateDir}/template-home.jsp"/>
    </c:otherwise>
</c:choose>
...
<tr class ="<%= classRow %>">
    ...
    <td valign="top"><a href='<c:out value="/${appName}/${encounter}"/>'><bean:write name="row" property="created" format="dd MMM yyyy"/></a>&nbsp;</td>
    ...
    <td valign="top" align="center">
        <c:choose>
            ...
            <c:otherwise>
                <c:if test="${zeprs_session.clientSettings.site.siteTypeId ==2}"><a href='<c:out value="/${appName}/${encounter}"/>'>Admit</a></c:if>
            </c:otherwise>
        </c:choose>
        &nbsp;</td>
