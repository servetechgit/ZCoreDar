...
<template:put name='content' direct='true'>
    ...
    <table>
        <tr>
            <td valign="top"><bean:message bundle="ApplicationResources" key="labels.admin.report.label"/>: </td>
            <td valign="top"><html:text property="label" /></td>
        </tr>
        <tr>
            <td valign="top"><bean:message bundle="ApplicationResources" key="labels.admin.report.sqlQuery"/>: </td>
            <td valign="top"><html:textarea rows="6" cols="40" property="sqlQuery" /></td>
        </tr>
        <tr>
            <td valign="top"><bean:message bundle="ApplicationResources" key="labels.admin.report.colLabels"/>: </td>
            <td valign="top"><html:textarea rows="6" cols="40" property="colLabels" /></td>
        </tr>
        <tr>
            <td valign="top"><bean:message bundle="ApplicationResources" key="labels.admin.report.primaryCategoryColumn"/>: </td>
            <td valign="top"><html:text property="primaryCategoryColumn" /></td>
        </tr>
        <tr>
            <td valign="top"><bean:message bundle="ApplicationResources" key="labels.admin.report.secondaryCategoryColumn"/>: </td>
        ...
        <tr>
            ...
            <html:javascript formName="adminReport" dynamicJavascript="true" staticJavascript="false" bundle="ApplicationResources"/>
            </html:form></td>
        </tr>
    </table>
</template:put>
