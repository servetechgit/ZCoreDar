                ...
                <table class="enhancedtable">
                    ...
                    <c:forEach items="${subscriptions}" var="subscription">
                        ...
                        <tr>
                            <td>
                                <c:choose>
                                    <c:when test="${ ! empty subscription.site}"><a href='<c:out value="/${appName}/${updateLink}"/>'>Update ${subscription.site}</a></c:when>
                                    <c:otherwise><a href='<c:out value="/${appName}/${importLink}"/>'>Import</a></c:otherwise>
                                </c:choose></td>
