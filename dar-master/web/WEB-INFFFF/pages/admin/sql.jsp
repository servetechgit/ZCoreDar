    ...
    <template:put name='content' direct='true'>
        ...
        <div>
            ...
            <ul>
                ...
                <li>Batch: MySQL-only. Execute several sql statements. Each line should contain a single SQL statement. There should be no line breaks in each SQL statement. Follow each SQL statement with a line feed. No blank lines between SQL statements.</li>
            </ul></p>
