...
<input type="hidden" name="fieldId" value="${providerId}"/>
    <table>
        <tr>
            <td valign="top"><h2><bean:message bundle="ApplicationResources" key="labels.admin.rule.ruleClass"/>:</h2>
                ...
                Select <bean:message bundle="ApplicationResources" key="labels.admin.rule.ruleClass"/>: <html:select property="ruleClass">
                <html:option value="org.rti.zcore.rules.impl.SimpleComparison">Simple
                    Comparison</html:option>
                <html:option value="org.cidrz.webapp.dynasite.rules.impl.ScriptRule">Script Rule</html:option>
            </html:select></td>
            <td valign="top"><h2><bean:message bundle="ApplicationResources" key="labels.admin.rule.outcomeClass"/>:</h2>
                <ul>
                ...
                Select <bean:message bundle="ApplicationResources" key="labels.admin.rule.outcomeClass"/>:
                <html:select property="outcomeClass">
                    <html:option value="org.rti.zcore.rules.impl.InfoOutcome">Info</html:option>
                    <html:option value="org.rti.zcore.rules.impl.EncounterOutcome">Encounter</html:option>
        ...
        <tr>
            ...
            <td valign="top"><bean:message bundle="ApplicationResources" key="labels.admin.rule.enabled"/>:
                <c:choose>
