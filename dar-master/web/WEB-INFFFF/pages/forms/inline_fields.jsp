...
<c:choose><%--Now show the page items--%>
    ...
    <c:when test='${field.type == "Enum"}'>
        <%@ include file="/WEB-INF/pages/forms/inline_enum.jsp" %>
    </c:when>
    ...
    <c:otherwise>
        <%@ include file="/WEB-INF/pages/forms/inline_text.jsp" %>
    </c:otherwise>
</c:choose>
