...
<div id="partoClose" style="display:none; border:none">
    ...
    <span id="partographCell">
        <form>
        Re-open: <input type="button" value="Re-open" id="is_open" name="is_open" onclick="insertOpenPartograph(1551,'field1551',${zeprs_session.sessionPatient.id}, ${zeprs_session.sessionPatient.currentEventId},'${user}',${siteId})" />
...
<script type='text/javascript'>
    ...
    reopenElement.innerHTML = 'Re-open: <input type="checkbox" id="is_open" name="is_open" onchange="insertOpenPartograph(1551,\'field1551\',${zeprs_session.sessionPatient.id}, ${zeprs_session.sessionPatient.currentEventId},\'${user}\',${siteId})"><input type="hidden"  id="is_closed" value="on"/>';
    }
