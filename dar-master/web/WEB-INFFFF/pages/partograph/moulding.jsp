    ...
    <c:forEach var="item" varStatus="loop"  begin="${startRow}" end="${stopRow}">
        <c:set var="pos" value="${loop.index}"/>
            ...
            <logic:notEmpty name="moulding" property="moulding${pos}">
                ...
                <div id="property${pos}">
                <select name="moulding${pos}" id="mouldingField${pos}" onchange="insertMoulding(${pos},'mouldingField${pos}',${zeprs_session.sessionPatient.id}, ${zeprs_session.sessionPatient.currentEventId},'${user}',${siteId})" style="display:none; border:none">
                    <option value="">--</option>
