    ...
    <c:forEach var="item" varStatus="loop"  begin="${startRowHour}" end="${stopRowHour}">
        <c:set var="pos" value="${loop.index}"/>
            ...
            <logic:notEmpty name="urinalysisGlucose" property="urinalysisGlucose${pos}">
                ...
                <div id="property${pos}">
                <select name="urinalysisGlucose${pos}" id="urinalysisGlucoseField${pos}" onchange="insertUrinalysisGlucose(${pos},'urinalysisGlucoseField${pos}',${zeprs_session.sessionPatient.id}, ${zeprs_session.sessionPatient.currentEventId},'${user}',${siteId})" style="display:none; border:none">
                    <option value="">--</option>
