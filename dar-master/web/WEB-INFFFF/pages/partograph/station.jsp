     ...
     <tr>
        <td colspan="2" id="positionCell${pos}">
            ...
            <table width="200" cellspacing="1" cellpadding="4" border="1">
                ...
                <tr>
                    ...
                    <img id =" pos5" src="/${appName}/images/position/circle180.gif" alt="Position 5" onclick="document.getElementById('positionField${pos}').value='Occiput Anterior';highlightImg('pos5');"></td>
                    <td align="center"><strong>Left Occiput Anterior</strong><br/>
                    <img id =" pos6" src="/${appName}/images/position/circle225.gif" alt="Position 6" onclick="document.getElementById('positionField${pos}').value='Left Occiput Anterior';highlightImg('pos6');"></td>
                    <td align="center"><strong>Right Occiput Anterior</strong><br/>
                    <img id =" pos4" src="/${appName}/images/position/circle135.gif" alt="Position 4" onclick="document.getElementById('positionField${pos}').value='Right Occiput Anterior';highlightImg('pos4');"></td>
                    <td align="center"><strong>Left Occiput Transverse</strong><br/>
                    <img id =" pos7" src="/${appName}/images/position/circle270.gif" alt="Position 7" onclick="document.getElementById('positionField${pos}').value='Left Occiput Transverse';highlightImg('pos7');"></td>
                </tr>
                <tr>
                    <td align="center"><strong>Right Occiput Transverse</strong><br/>
                    <img id =" pos3" src="/${appName}/images/position/circle90.gif" alt="Position 3" onclick="document.getElementById('positionField${pos}').value='Right Occiput Transverse';highlightImg('pos3');"></td>
                    <td align="center"><strong>Left Occiput Posterior</strong><br/>
                    <img id =" pos8" src="/${appName}/images/position/circle315.gif" alt="Position 8" onclick="document.getElementById('positionField${pos}').value='Left Occiput Posterior';highlightImg('pos8');"></td>
                    <td align="center"><strong>Occiput Posterior</strong><br/>
                    <img id =" pos1" src="/${appName}/images/position/circle.gif" alt="Occiput Posterior" onclick="document.getElementById('positionField${pos}').value='Occiput Posterior';highlightImg('pos1');"></td>
                    <td align="center"><strong>Right Occiput Posterior</strong>r<br/>
                    <img id =" pos2" src="/${appName}/images/position/circle45.gif" alt="Right Occiput Posterior" onclick="document.getElementById('positionField${pos}').value='Right Occiput Posterior';highlightImg('pos2');"></td>
                </tr>
            </table>
            </div>
        </td>
      ...
      <tr>
        <td colspan="2" id="cordCell${pos}" valign="bottom" align="right">
            <div id="cord${pos}"><input class='ibutton' type='button' title="Save" value="Save" onclick="insertStation(${zeprs_session.sessionPatient.id}, ${zeprs_session.sessionPatient.currentEventId},'${user}',${siteId})">
            </div>
        </td>
     </tr>
</table>
...
<c:forEach var="item" varStatus="loop" begin="4" end="13">
    ...
    <tr id="stationRow${pos}">
        ...
        <logic:notEmpty name="station" property="station${pos}">
            ...
            <select name="station${pos}" id="stationField${pos}" onchange="insertStation(${pos},'stationField${pos}',${zeprs_session.sessionPatient.id}, ${zeprs_session.sessionPatient.currentEventId},'${user}',${siteId})" style="display:none; border:none">
                <option value="">--</option>
                <option value="-5/5">-5/5</option>
                <option value="-4/5">-4/5</option>
                <option value="-3/5">-3/5</option>
