...
<c:forEach var="item" varStatus="loop" begin="1" end="6">
    ...
    <tr id="stationRow${pos}">
        ...
        <logic:notEmpty name="vaginalExam" property="timeObservation${pos}">
            ...
            <br/>
            <input type="button" name="_add" value="Done" onclick="insertVaginalExam(${pos},'timeObservationField${pos}', 'VaginalExamParto', 'timeObservation', replyTimeObservation, ${zeprs_session.sessionPatient.id}, ${zeprs_session.sessionPatient.currentEventId},'${user}',${siteId}); toggle2('timeObservationSpan${pos}')">
            </span>
        </logic:notEmpty>
        ...
        <logic:notEmpty name="vaginalExam" property="station${pos}">
            ...
            <br/>
            <select name="station${pos}" id="stationField${pos}" onchange="insertVaginalExam(${pos},'stationField${pos}', 'VaginalExamParto', 'station', replyStation, ${zeprs_session.sessionPatient.id}, ${zeprs_session.sessionPatient.currentEventId},'${user}',${siteId})" style="display:none;">
                <option value="">--</option>
        ...
        <logic:empty name="vaginalExam" property="station${pos}">
            ...
            <select name="station${pos}" id="stationField${pos}" onchange="insertVaginalExam(${pos},'stationField${pos}', 'VaginalExamParto', 'station', replyStation, ${zeprs_session.sessionPatient.id}, ${zeprs_session.sessionPatient.currentEventId},'${user}',${siteId})">
                <option value="">--</option>
                <option value="-5/5">-5/5</option>
                <option value="-4/5">-4/5</option>
                <option value="-3/5">-3/5</option>
        ...
        <logic:notEmpty name="vaginalExam" property="position${pos}">
            ...
            <br/>
            <select name="position${pos}" id="positionField${pos}"  onchange="insertVaginalExam(${pos}, 'positionField${pos}', 'VaginalExamParto', 'position', replyPosition, ${zeprs_session.sessionPatient.id}, ${zeprs_session.sessionPatient.currentEventId},'${user}',${siteId})" style="display:none;">
                <option value="">--</option>
        ...
        <logic:empty name="vaginalExam" property="position${pos}">
            ...
            <select name="position${pos}" id="positionField${pos}" onchange="insertVaginalExam(${pos}, 'positionField${pos}', 'VaginalExamParto', 'position', replyPosition, ${zeprs_session.sessionPatient.id}, ${zeprs_session.sessionPatient.currentEventId},'${user}',${siteId})">
                <option value="">--</option>
                <option value="Occiput Anterior">Occiput Anterior</option>
                <option value="Left Occiput Anterior">Left Occiput Anterior</option>
                <option value="Right Occiput Anterior">Right Occiput Anterior</option>
        ...
        <logic:notEmpty name="vaginalExam" property="cord${pos}">
            ...
            <br/>
            <select name="cord${pos}" id="cordField${pos}"  onchange="insertVaginalExam(${pos}, 'cordField${pos}', 'VaginalExamParto', 'cord', replyCord, ${zeprs_session.sessionPatient.id}, ${zeprs_session.sessionPatient.currentEventId},'${user}',${siteId})" style="display:none;">
                <option value="">--</option>
        ...
        <logic:empty name="vaginalExam" property="cord${pos}">
            ...
            <select name="cord${pos}" id="cordField${pos}"  onchange="insertVaginalExam(${pos}, 'cordField${pos}', 'VaginalExamParto', 'cord', replyCord, ${zeprs_session.sessionPatient.id}, ${zeprs_session.sessionPatient.currentEventId},'${user}',${siteId})">
                <option value="">--</option>
                <option value="Not Palpable">Not Palpable</option>
                <option value="Palpable">Palpable</option>
                <option value="Prolapsed">Prolapsed</option>
        ...
        <logic:notEmpty name="vaginalExam" property="vulva${pos}">
            ...
            <br/>
            <select name="vulva${pos}" id="vulvaField${pos}"  onchange="insertVaginalExam(${pos}, 'vulvaField${pos}', 'VaginalExamParto', 'vulva', replyVulva, ${zeprs_session.sessionPatient.id}, ${zeprs_session.sessionPatient.currentEventId},'${user}',${siteId})" style="display:none;">
                <option value="">--</option>
        ...
        <logic:empty name="vaginalExam" property="vulva${pos}">
            ...
            <select name="vulva${pos}" id="vulvaField${pos}"  onchange="insertVaginalExam(${pos}, 'vulvaField${pos}', 'VaginalExamParto', 'vulva', replyVulva, ${zeprs_session.sessionPatient.id}, ${zeprs_session.sessionPatient.currentEventId},'${user}',${siteId})">
                <option value="">--</option>
                <option value="Normal">Normal</option>
                <option value="Warts">Warts</option>
                <option value="Ulcers">Ulcers</option>
        ...
        <logic:notEmpty name="vaginalExam" property="vagina${pos}">
            ...
            <br/>
            <select name="vagina${pos}" id="vaginaField${pos}"  onchange="insertVaginalExam(${pos}, 'vaginaField${pos}', 'VaginalExamParto', 'vagina', replyVagina, ${zeprs_session.sessionPatient.id}, ${zeprs_session.sessionPatient.currentEventId},'${user}',${siteId})" style="display:none;">
                <option value="">--</option>
                <option value="Normal">Normal</option>
        ...
        <logic:empty name="vaginalExam" property="vagina${pos}">
            ...
            <select name="vagina${pos}" id="vaginaField${pos}"  onchange="insertVaginalExam(${pos}, 'vaginaField${pos}', 'VaginalExamParto', 'vagina', replyVagina, ${zeprs_session.sessionPatient.id}, ${zeprs_session.sessionPatient.currentEventId},'${user}',${siteId})">
                <option value="">--</option>
                <option value="Normal">Normal</option>
                <option value="Warm">Warm</option>
                <option value="Hot">Hot</option>
        ...
        <td valign="top">
            <table width="100px" cellspacing="1" cellpadding="4" border="1">
                <tr>
                    ...
                    <img id =" pos6" src="/${appName}/images/position/circle45.gif" alt="Left Occiput Anterior"></td>
                    <td align="center" colspan="2"><strong>Occiput Anterior</strong><br/>
                    <img id =" pos5" src="/${appName}/images/position/circle.gif" alt="Occiput Anterior"></td>
                    <td align="center"><strong>Right Occiput Anterior</strong><br/>
                    <img id =" pos4" src="/${appName}/images/position/circle315.gif" alt="Right Occiput Anterior"></td>
                </tr>
                <tr>
                    <td align="center"><strong>Left Occiput Transverse</strong><br/>
                    <img id =" pos7" src="/${appName}/images/position/circle90.gif" alt="Left Occiput Transverse"></td>
                    <td align="center" colspan="2">&nbsp;</td>
                    <td align="center"><strong>Right Occiput Transverse</strong><br/>
                    <img id =" pos3" src="/${appName}/images/position/circle270.gif" alt="Right Occiput Transverse"></td>
                </tr>
                <tr>
                    <td align="center"><strong>Left Occiput Posterior</strong><br/>
                    <img id =" pos8" src="/${appName}/images/position/circle135.gif" alt="Left Occiput Posterior"></td>
                    <td align="center" colspan="2"><strong>Occiput Posterior</strong><br/>
                    <img id =" pos1" src="/${appName}/images/position/circle180.gif" alt="Occiput Posterior"></td>
                    <td align="center"><strong>Right Occiput Posterior</strong>r<br/>
                    <img id =" pos2" src="/${appName}/images/position/circle225.gif" alt="Right Occiput Posterior"></td>
                </tr>
            </table>
        </td>
    </tr>
