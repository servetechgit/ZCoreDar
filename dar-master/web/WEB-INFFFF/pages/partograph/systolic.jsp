...
Systol.: <img src="/${appName}/images/arrow_up_red.gif">
</p>
<p>
...
<c:choose>
    <c:when test="${! empty bloodPressure}">
        <c:forEach var="item" varStatus="loop" begin="${startRow}" end="${stopRow}">
            ...
            <logic:equal value="${row}" name="bloodPressure" property="systolic${pos}">
                <td valign="top" onclick="insertSystolic(${row}, ${pos},${zeprs_session.sessionPatient.id}, ${zeprs_session.sessionPatient.currentEventId},'${user}',${siteId} )" id="systolicCell${row}.${pos}">
                    <div id="systolicCellDiv${row}.${pos}">
                        <img alt="systolicImg${row}.${pos}" id="systolicImg${row}.${pos}" src="/${appName}/images/arrow_up_red.gif">
                        <c:if test="${! empty pulse}">
                            <logic:equal value="${row}" name="pulse" property="pulse${pos}">
                                <img alt="pulseImgBS${row}.${pos}" id="pulseImgBS${row}.${pos}" src="/${appName}/images/dot.gif">
                            </logic:equal>
                        </c:if>
                        <logic:equal value="${row}" name="bloodPressure" property="diastolic${pos}">
                            <img alt="diastolicImg${row}.${pos}" id="diastolicImgBS${row}.${pos}" src="/${appName}/images/arrow_down.gif">
                        </logic:equal>
                    </div>
                </td>
            </logic:equal>
    ...
    <c:otherwise>
        <c:forEach var="item" varStatus="loop"  begin="${startRow}" end="${stopRow}" >
            <c:set var="pos" value="${loop.index}"/>
            <td valign="top" onclick="insertSystolic(${row}, ${loop.index},${zeprs_session.sessionPatient.id}, ${zeprs_session.sessionPatient.currentEventId},'${user}',${siteId} )" id="systolicCell${row}.${loop.index}">
                <div id="systolicCellDiv${row}.${pos}">
                &nbsp;
                <c:if test="${! empty pulse}">
                    <logic:equal value="${row}" name="pulse" property="pulse${pos}">
...
var replySystolic = function(data) {
    ...
    //sitem.innerHTML = '<img alt="systolicImg'  + row + "." + column + '" id="systolicImg'  + row + "." + column + '" src="/${appName}/images/arrow_up_red.gif">';
    //ditem.innerHTML = '<img alt="systolicImgB'  + row + "." + column + '" id="systolicImg'  + row + "." + column + '" src="/${appName}/images/arrow_up.gif">';
    //pitem.innerHTML = '<img alt="systolicImgB'  + row + "." + column + '" id="systolicImg'  + row + "." + column + '" src="/${appName}/images/arrow_up.gif">';
