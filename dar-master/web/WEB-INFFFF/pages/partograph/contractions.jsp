                    ...
                    <c:when test="${row == itemRow}">
                        ...
                        <div id="property${pos}">
                            <select name="contractions${pos}" id="contractionsField${row}.${pos}"
                                    onchange="insertContractions(${pos}, '${row}',${zeprs_session.sessionPatient.id}, ${zeprs_session.sessionPatient.currentEventId},'${user}',${siteId})"
...
var replyContractions = function(data)
{
    ...
    // var dots = '<img src="/${appName}/images/dots.gif">';
    // alert("value: " + value);
    if (value == "Mild") {
