    ...
    <c:forEach var="item" varStatus="loop"  begin="${startRowHour}" end="${stopRowHour}">
        <c:set var="pos" value="${loop.index}"/>
            ...
            <logic:notEmpty name="respiration" property="respiration${pos}">
                ...
                <div id="property${pos}"><input type="text" name="respiration${pos}" id="respirationField${pos}" onchange="insertRespiration(${pos},'respirationField${pos}',${zeprs_session.sessionPatient.id}, ${zeprs_session.sessionPatient.currentEventId},'${user}',${siteId})" style="display:none;" size="3" maxlength="4">
                </div>
            </logic:notEmpty>
            <logic:empty name="respiration" property="respiration${pos}">
                <div id="respirationValue${pos}"></div>
                <div id="property${pos}"><input type="text" name="respiration${pos}" id="respirationField${pos}" onchange="insertRespiration(${pos},'respirationField${pos}',${zeprs_session.sessionPatient.id}, ${zeprs_session.sessionPatient.currentEventId},'${user}',${siteId})" style="display:none;" size="3" maxlength="4"></div>
            </logic:empty>
            </td>
    </c:forEach>
    </c:when>
