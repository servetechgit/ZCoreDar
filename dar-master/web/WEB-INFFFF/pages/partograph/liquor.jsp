    ...
    <c:forEach var="item" varStatus="loop"  begin="${startRow}" end="${stopRow}">
        <c:set var="pos" value="${loop.index}"/>
            ...
            <logic:notEmpty name="liquor" property="liquor${pos}">
                ...
                <div id="property${pos}">
                    <select name="liquor${pos}" id="liquorField${pos}" onchange="insertLiquor(${pos}, 'liquorField${pos}',${zeprs_session.sessionPatient.id}, ${zeprs_session.sessionPatient.currentEventId},'${user}',${siteId})" style="display:none; border:none">
                        <option value="">--</option>
