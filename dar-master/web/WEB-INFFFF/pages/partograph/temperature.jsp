    ...
    <c:forEach var="item" varStatus="loop"  begin="${startRowHour}" end="${stopRowHour}">
        <c:set var="pos" value="${loop.index}"/>
            ...
            <logic:notEmpty name="temperature" property="temperature${pos}">
                ...
                <div id="property${pos}"><input type="text" name="temperature${pos}" id="temperatureField${pos}" onchange="insertTemperature(${pos},'temperatureField${pos}',${zeprs_session.sessionPatient.id}, ${zeprs_session.sessionPatient.currentEventId},'${user}',${siteId})" style="display:none;" size="3" maxlength="4"></div>
            </logic:notEmpty>
