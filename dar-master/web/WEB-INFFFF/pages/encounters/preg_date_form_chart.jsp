...
<logic:notEmpty name="${encounterForm.classname}" property="field1">
    <bean:define id="dateFromDb" name="${encounterForm.classname}" property="field1"/>
...
<logic:empty name="${encounterForm.classname}" property="field1">
...
<logic:notEmpty name="${encounterForm.classname}" property="field1962">
   <bean:define id="lmpDateFromDb" name="${encounterForm.classname}" property="field1962"/>
...
<script type='text/javascript' src='/${appName}/dwr/engine.js;jsessionid=${pageContext.request.session.id}'></script>
...
<tr>
    ...
    <span id="spanfield1" onclick="showCalendar('${yearnow}','${monthnow}','${datenow}','dd/MM/yyyy','form82','field1',event,2003,2007);" class="dateDisplay">${nicedateVisit}</span>
    ...
    <td align="left" valign="top" class="lmp">
        ...
        <div id="lmpChoice">
        <p>LMP:<br/>
                <script language="JavaScript" type="text/javascript" src="/${appName}/js/pregnant.js;jsessionid=${pageContext.request.session.id}"></script>
