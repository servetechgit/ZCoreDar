...
<template:insert template='/WEB-INF/templates/${appTemplateDir}/template-report.jsp'>
...
<div id="reporttitle"><h1>Pregnancy and Discharge Summary - Site: ${zeprs_session.clientSettings.site.name}</h1></div>
