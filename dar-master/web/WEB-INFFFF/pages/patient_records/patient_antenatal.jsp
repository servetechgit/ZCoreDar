...
<script language="JavaScript" type='text/javascript' src='/${appName}/dwr/interface/Antenatal.js;jsessionid=${pageContext.request.session.id}'></script>
...
<html:form action="${encounterForm.classname}/save.do?patientId=${zeprs_session.sessionPatient.id}" onsubmit="return validateForm${encounterForm.id}(this);">
    <c:choose>
