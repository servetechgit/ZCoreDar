...
<c:set var="sixtyYears" value="${yearnow - 60}"/>
    <a href="javascript://" onclick="showCalendar('${yearnow}','${monthnow}','${datenow}','dd/MM/yyyy','problem','onsetDate',event,${lastTwoYears},${twoYears});">
    <img alt="Select Date" border="0" src="/${appName}/images/calendar.gif" align="middle">&nbsp;&nbsp;</a><span id="spanonsetDate" class="dateDisplay">${niceonsetDate}</span>
