...
<%@ attribute name="form" required="true" type="org.rti.zcore.Form" %>
...
function emptyList${field.identifier}( box ) {
...
function fillList${field.identifier}( box, arr ) {
...
function changeList${field.identifier}( box ) {
...
<c:when test="${field.id=='1314'}">
    emptyList${field.identifier}( box.form.field1319 );
	fillList${field.identifier}( box.form.field1319, dose );
    emptyList${field.identifier}( box.form.field1324 );
	fillList${field.identifier}( box.form.field1324, brand );
}
</c:when>
<c:when test="${field.id=='1315'}">
    emptyList${field.identifier}( box.form.field1320 );
    fillList${field.identifier}( box.form.field1320, dose );
    emptyList${field.identifier}( box.form.field1325 );
	fillList${field.identifier}( box.form.field1325, brand );
}
</c:when>
<c:when test="${field.id=='1316'}">
    emptyList${field.identifier}( box.form.field1321 );
    fillList${field.identifier}( box.form.field1321, dose );
    emptyList${field.identifier}( box.form.field1326 );
	fillList${field.identifier}( box.form.field1326, brand );
}
</c:when>
<c:when test="${field.id=='1317'}">
    emptyList${field.identifier}( box.form.field1322 );
    fillList${field.identifier}( box.form.field1322, dose );
    emptyList${field.identifier}( box.form.field1327 );
	fillList${field.identifier}( box.form.field1327, brand );
}
</c:when>
<c:when test="${field.id=='1318'}">
    emptyList${field.identifier}( box.form.field1323 );
    fillList${field.identifier}( box.form.field1323, dose );
    emptyList${field.identifier}( box.form.field1328 );
	fillList${field.identifier}( box.form.field1328, brand );
}
</c:when>
</c:choose>
</script>
    ...
    <c:if test='${field.enabled ==true}'>
        ...
        <c:choose>
            ...
            <c:when test="${field.type=='Drug:dosage'}"></c:when>
            <c:when test='${field.displayHint.inputType=="hidden1"}'></c:when>
            <c:otherwise><bean:message key="${encounterForm.classname}.${field.identifier}" bundle="${encounterForm.classname}Messages" />:</c:otherwise>
        </c:choose>
        <c:if test='${field.type=="Section title"}'></strong></c:if>
        <c:choose>
            <c:when test="${field.type=='Drug:brand'}"></c:when>
        ...
        <c:choose>
             <c:when test='${field.type=="Date"}'>
                <c:choose>
                    <c:when test='${field.displayHint.inputType=="text"}'>
                        <td colspan="5" align="left"><html:text size="10" maxlength="10" property="${field.identifier}" value="${daynow}" /> (Format: DD/MM/YYYY)</td>
                    </c:when>
                    <c:when test='${field.displayHint.inputType=="date1"}'>
                        <td colspan="5" align="left"><table cellpadding="0" cellspacing="0"><tr><td><a href="javascript:cal_${field.identifier}.popup();">
                        <img src="/art/images/cal.gif" align="middle" width="26" height="20" border="0" alt="Click Here to Pick up the timestamp"></a></td><td>&nbsp;<html:text size="10" maxlength="10"  onfocus="this.blur()" styleClass="disabled" property="${field.identifier}" /></td></tr></table></td>
                    </c:when>
                    <c:when test='${field.displayHint.inputType=="date2"}'>
                        <td colspan="5" align="left"><table cellpadding="0" cellspacing="0"><tr><td><a href="javascript:cal_${field.identifier}.popup();">
                        <img src="/art/images/cal.gif" align="middle" width="26" height="20" border="0" alt="Click Here to Pick up the timestamp"></a></td><td>&nbsp;<html:text size="10" maxlength="10" onfocus="this.blur()" styleClass="disabled" property="${field.identifier}" value="${daynow}" /></td></tr></table></td>
                    </c:when>
                    <c:when test='${field.displayHint.inputType=="date3"}'>
                        <td colspan="5" align="left"><table cellpadding="0" cellspacing="0"><tr><td><a href="javascript:cal_${field.identifier}.popup();">
                        <img src="/art/images/cal.gif" align="middle" width="26" height="20" border="0" alt="Click Here to Pick up the timestamp"></a></td><td>&nbsp;<html:text size="10" maxlength="10"  onfocus="this.blur()" styleClass="disabled" property="${field.identifier}" value="${fmtdate1weekfuture}"  /></td></tr></table></td>
                    </c:when>
                    <c:when test='${field.displayHint.inputType=="date5"}'>
                        <td colspan="5" align="left"><table cellpadding="0" cellspacing="0"><tr><td>
                            <select name="theDate" onchange="this.form.${field.identifier}.value = theDate[this.selectedIndex].value;" >
                        ...
                        <td>&nbsp;<a href="javascript:cal_${field.identifier}.popup();">
                        <img src="/art/images/cal.gif" align="middle" width="26" height="20" border="0" alt="Click Here to Pick up the timestamp"></a></td><td>&nbsp;<html:text size="10" maxlength="10"  onfocus="this.blur()" styleClass="disabled" property="${field.identifier}" value="${fmtdate1weekfuture}"  /></td></tr></table></td>
                    </c:when>
            ...
            <c:when test='${field.type=="Drug:type"}'>
                ...
                <td>
                <html:select onchange="changeList${field.identifier}(this)" property="${field.identifier}" >
