...
<strong>Date:</strong> <span class="asterix">*</span>
    <a href="javascript://" onclick="showCalendar('${yearnow}','${monthnow}','${datenow}','dd MMM yy','${element}','${field}',event,${lastTwoYears},${twoYears});">
    <img alt="Select Date" border="0" src="/${appName}/images/calendar.gif" align="middle"></a>&nbsp;&nbsp;<span id="span${field}" class="dateDisplay">${nicedateVisit}</span>
