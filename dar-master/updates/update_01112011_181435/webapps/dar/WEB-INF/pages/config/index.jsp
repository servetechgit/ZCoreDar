...
<p><strong>Appointment Threshold Notifications</strong></p>
<p>Use the following form to edit the threshold for appointment notifications</p>
...
<c:url value="admin/records/list.do" var="regimen_item"><c:param name="formId" value="181"/></c:url>
