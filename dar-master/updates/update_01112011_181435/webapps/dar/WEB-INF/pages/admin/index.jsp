...
<td>Delete multiple patients.</td>
	...
	<ul>
	    ...
	    <li><a href='<c:out value="/${appName}/admin/${importData}"/>' onclick="return confirm('Caution: Are you sure you want to import data?');self.close();">Import data (Place data in archives/SITE/import)</a></li>
	...
	<div id="testRecords" style="visibility:hidden;display:none">
	    ...
	    <ul>
	        <li><bean:message bundle="ApplicationResources" key="admin.index.test.single"/><ul>
	             <li><html:link action="/admin/createPatient.do"><bean:message bundle="ApplicationResources" key="admin.index.test0"/></html:link></li>
	             <li><html:link href="createPatient.do;jsessionid=${pageContext.request.session.id}?patientType=child"><bean:message bundle="ApplicationResources" key="admin.index.test0C"/></html:link></li>
	         </ul>
	          <li><bean:message bundle="ApplicationResources" key="admin.index.test.mult"/><html:link href="createPatient.do;jsessionid=${pageContext.request.session.id}?number=1" onclick="return confirm('Create 10 test patients? This will take about a minute.');self.close();">10</html:link>
