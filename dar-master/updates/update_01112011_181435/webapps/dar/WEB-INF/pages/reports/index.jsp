...
<p>Note: If you would like to generate Monthly Reports, select "Monthly Reports for ARV and OI" and
use the "End Date" calendar widget to select a day the month for which you would like to report.
The report will automatically adjust the date range to cover the whole month</p>
	...
	<tr>
		<td>
			<html:select property="report" size="1">
				<html:option value="10">Combined Monthly Reports for CDRR/ARV's</html:option>
