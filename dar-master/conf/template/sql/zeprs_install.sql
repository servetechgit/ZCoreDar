...
-- ZEPRS db dump buildDate: 2006/10/17 15:30 - buildNum: 171
-- 
...
--
-- Current Database: `zeprs`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `zeprs` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
CREATE TABLE `infantdischargesummary` (
  ...
  `baby_received_arv` tinyint(4) default NULL,
...
CREATE TABLE `patient` (
  ...
  CONSTRAINT `FKD0D3EB057D2B7913` FOREIGN KEY (`site_id`) REFERENCES `site` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `user_group_membership` VALUES ('clerk',16,NULL,NULL,NULL),('clinic',5,NULL,NULL,NULL),('luser',16,NULL,NULL,NULL),('reports',15,NULL,NULL,NULL),('useradmin',9,NULL,NULL,NULL),('viewall',16,NULL,NULL,NULL),('zepadmin',1,NULL,NULL,NULL);
UNLOCK TABLES;
