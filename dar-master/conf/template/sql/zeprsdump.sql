...
--
-- Table structure for table `casemrgdb`
--

DROP TABLE IF EXISTS `casemrgdb`;
CREATE TABLE `casemrgdb` (
  `id` bigint(20) NOT NULL default '0',
  `case_number` varchar(255) default NULL,
  `court` varchar(255) default NULL,
  PRIMARY KEY  (`id`),
  KEY `FKcaseMrgDb` (`id`),
  CONSTRAINT `FKcaseMrgDb` FOREIGN KEY (`id`) REFERENCES `encounter` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `casemrgdb`
--


/*!40000 ALTER TABLE `casemrgdb` DISABLE KEYS */;
LOCK TABLES `casemrgdb` WRITE;
UNLOCK TABLES;
/*!40000 ALTER TABLE `casemrgdb` ENABLE KEYS */;
...
CREATE TABLE `deliverysum` (
  ...
  `regimen` int(11) default NULL,
  `hiv_tested_in_labour` tinyint(4) default NULL,
...
--
-- Table structure for table `testl1`
--
...
CREATE TABLE `testl1` (
  ...
  `heightTest` float default NULL,
  `commentTest` varchar(255) default NULL,
  PRIMARY KEY  (`id`),
  KEY `FKtestL1` (`id`),
  CONSTRAINT `FKtestL1` FOREIGN KEY (`id`) REFERENCES `encounter` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `testl1`
--


/*!40000 ALTER TABLE `testl1` DISABLE KEYS */;
LOCK TABLES `testl1` WRITE;
INSERT INTO `testl1` VALUES (667340,3190,167.5,'wow - that must have hurt alot!');
UNLOCK TABLES;
/*!40000 ALTER TABLE `testl1` ENABLE KEYS */;

--
-- Table structure for table `testl2`
--

DROP TABLE IF EXISTS `testl2`;
CREATE TABLE `testl2` (
  `id` bigint(20) NOT NULL default '0',
  `locationTest` int(11) default NULL,
  `commentsTest` varchar(255) default NULL,
  `weightTest` float default NULL,
  PRIMARY KEY  (`id`),
  KEY `FKtestL2` (`id`),
  CONSTRAINT `FKtestL2` FOREIGN KEY (`id`) REFERENCES `encounter` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `testl2`
--


/*!40000 ALTER TABLE `testl2` DISABLE KEYS */;
LOCK TABLES `testl2` WRITE;
INSERT INTO `testl2` VALUES (667342,3196,'hhg ghgh',23.5);
UNLOCK TABLES;
/*!40000 ALTER TABLE `testl2` ENABLE KEYS */;
