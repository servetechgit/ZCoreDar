...
public class ZEPRSUtils {
     ...
     * @throws ServletException
     */
    public static ResultSet getPatientEncounters(Long patientID, Date beginDate, Date endDate, Connection conn) throws ServletException {

    	ResultSet rs = null;
    	try {
    		String sql = "SELECT id FROM encounter" +
    		" WHERE patient_id = ? \n" +
    		"AND date_visit >= ? AND date_visit <= ? \n" +
    		"ORDER BY date_visit";
    		PreparedStatement ps = conn.prepareStatement(sql);
     ...
     * @throws ServletException
     */
    protected static ResultSet getScheduledVisits(Date beginDate, Date endDate, int siteID, Connection conn) throws ServletException {
	 ...
	 * @throws ServletException
	 */
	public static ResultSet getPatientArtRegimen(Connection conn, Long patientId, Date beginDate, Date endDate) throws ServletException {
		ResultSet rs = null;
